...
static void initialize_c1_testing_control_with_feedback_estimate
  (SFc1_testing_control_with_feedback_estimateInstanceStruct *chartInstance);
static void initialize_params_c1_testing_control_with_feedback_estimate
  (SFc1_testing_control_with_feedback_estimateInstanceStruct *chartInstance);
static void enable_c1_testing_control_with_feedback_estimate
  (SFc1_testing_control_with_feedback_estimateInstanceStruct *chartInstance);
static void disable_c1_testing_control_with_feedback_estimate
  (SFc1_testing_control_with_feedback_estimateInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_testing_control_with_feedback_estima
  (SFc1_testing_control_with_feedback_estimateInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_testing_control_with_feedback_estimate
  (SFc1_testing_control_with_feedback_estimateInstanceStruct *chartInstance);
static void set_sim_state_c1_testing_control_with_feedback_estimate
  (SFc1_testing_control_with_feedback_estimateInstanceStruct *chartInstance,
   const mxArray *c1_st);
static void finalize_c1_testing_control_with_feedback_estimate
  (SFc1_testing_control_with_feedback_estimateInstanceStruct *chartInstance);
static void sf_c1_testing_control_with_feedback_estimate
  (SFc1_testing_control_with_feedback_estimateInstanceStruct *chartInstance);
static void initSimStructsc1_testing_control_with_feedback_estimate
  (SFc1_testing_control_with_feedback_estimateInstanceStruct *chartInstance);
...
static uint8_T c1_d_emlrt_marshallIn
  (SFc1_testing_control_with_feedback_estimateInstanceStruct *chartInstance,
   const mxArray *c1_b_is_active_c1_testing_control_with_feedback_estimate,
  ...
  (SFc1_testing_control_with_feedback_estimateInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_testing_control_with_feedback_estimate = 0U;
}
  ...
  (SFc1_testing_control_with_feedback_estimateInstanceStruct *chartInstance)
{
  ...
  c1_c_hoistedGlobal =
    chartInstance->c1_is_active_c1_testing_control_with_feedback_estimate;
   ...
   const mxArray *c1_st)
{
  ...
  *c1_Vq = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 1)),
  ...
  chartInstance->c1_is_active_c1_testing_control_with_feedback_estimate =
    ...
    "is_active_c1_testing_control_with_feedback_estimate");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_testing_control_with_feedback_estima(chartInstance);
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_testing_control_with_feedback_estimateInstanceStruct *chartInstance;
  chartInstance = (SFc1_testing_control_with_feedback_estimateInstanceStruct *)
    chartInstanceVoid;
   ...
   const char_T *c1_identifier)
{
  ...
  c1_y = c1_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_testing_control_with_feedback_estimate), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_testing_control_with_feedback_estimate);
  return c1_y;
}
...
/* SFunction Glue Code */
void sf_c1_testing_control_with_feedback_estimate_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(70235798U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3772346386U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4273935242U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(696797490U);
}

mxArray *sf_c1_testing_control_with_feedback_estimate_get_autoinheritance_info
  (void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("05ckiKN2t1oN4ND1Q9aIFH");
...
static const mxArray
  *sf_get_sim_state_info_c1_testing_control_with_feedback_estimate(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"Vd\",},{M[1],M[7],T\"Vq\",},{M[8],M[0],T\"is_active_c1_testing_control_with_feedback_estimate\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_testing_control_with_feedback_estimate_get_check_sum(&mxChecksum);
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",286,-1,866);
...
{
  return "bTX77wzPF7Ua5dNYh6E1tF";
}

static void sf_opaque_initialize_c1_testing_control_with_feedback_estimate(void *
  chartInstanceVar)
{
  chart_debug_initialization
    (((SFc1_testing_control_with_feedback_estimateInstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c1_testing_control_with_feedback_estimate
    ((SFc1_testing_control_with_feedback_estimateInstanceStruct*)
     chartInstanceVar);
  initialize_c1_testing_control_with_feedback_estimate
    ((SFc1_testing_control_with_feedback_estimateInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c1_testing_control_with_feedback_estimate(void
  *chartInstanceVar)
{
  enable_c1_testing_control_with_feedback_estimate
    ((SFc1_testing_control_with_feedback_estimateInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c1_testing_control_with_feedback_estimate(void
  *chartInstanceVar)
{
  disable_c1_testing_control_with_feedback_estimate
    ((SFc1_testing_control_with_feedback_estimateInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c1_testing_control_with_feedback_estimate(void
  *chartInstanceVar)
{
  sf_c1_testing_control_with_feedback_estimate
    ((SFc1_testing_control_with_feedback_estimateInstanceStruct*)
     chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c1_testing_control_with_feedback_estimate(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_testing_control_with_feedback_estimate
    ((SFc1_testing_control_with_feedback_estimateInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c1_testing_control_with_feedback_estimate();/* state var info */
...
extern void sf_internal_set_sim_state_c1_testing_control_with_feedback_estimate
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c1_testing_control_with_feedback_estimate
    ((SFc1_testing_control_with_feedback_estimateInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c1_testing_control_with_feedback_estimate(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_testing_control_with_feedback_estimate(S);
}

static void sf_opaque_set_sim_state_c1_testing_control_with_feedback_estimate
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c1_testing_control_with_feedback_estimate(S, st);
}

static void sf_opaque_terminate_c1_testing_control_with_feedback_estimate(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_testing_control_with_feedback_estimateInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c1_testing_control_with_feedback_estimate
      ((SFc1_testing_control_with_feedback_estimateInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc1_testing_control_with_feedback_estimate
    ((SFc1_testing_control_with_feedback_estimateInstanceStruct*)
     chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_testing_control_with_feedback_estimate
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_testing_control_with_feedback_estimate(SimStruct
  *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
  ...
  ssSetChecksum0(S,(4222996704U));
  ssSetChecksum1(S,(441864843U));
  ssSetChecksum2(S,(148421379U));
  ssSetChecksum3(S,(716860114U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c1_testing_control_with_feedback_estimate(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_testing_control_with_feedback_estimate(SimStruct *S)
{
  SFc1_testing_control_with_feedback_estimateInstanceStruct *chartInstance;
  chartInstance = (SFc1_testing_control_with_feedback_estimateInstanceStruct *)
    malloc(sizeof(SFc1_testing_control_with_feedback_estimateInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_testing_control_with_feedback_estimate;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_testing_control_with_feedback_estimate;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_testing_control_with_feedback_estimate;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c1_testing_control_with_feedback_estimate;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_testing_control_with_feedback_estimate;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_testing_control_with_feedback_estimate;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_testing_control_with_feedback_estimate;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_testing_control_with_feedback_estimate;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c1_testing_control_with_feedback_estimate;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c1_testing_control_with_feedback_estimate;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_testing_control_with_feedback_estimate;
...
void c1_testing_control_with_feedback_estimate_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_testing_control_with_feedback_estimate(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_testing_control_with_feedback_estimate(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_testing_control_with_feedback_estimate(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_testing_control_with_feedback_estimate_method_dispatcher.\n"
