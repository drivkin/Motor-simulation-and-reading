...
#include "c3_motor_control_with_homebrew_SVPWM.h"
...
static void initialize_c3_motor_control_with_homebrew_SVPWM
  (SFc3_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance);
static void initialize_params_c3_motor_control_with_homebrew_SVPWM
  (SFc3_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance);
static void enable_c3_motor_control_with_homebrew_SVPWM
  (SFc3_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance);
static void disable_c3_motor_control_with_homebrew_SVPWM
  (SFc3_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_motor_control_with_homebrew_SVPWM
  (SFc3_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_motor_control_with_homebrew_SVPWM
  (SFc3_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance);
static void set_sim_state_c3_motor_control_with_homebrew_SVPWM
  (SFc3_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance, const
   mxArray *c3_st);
static void finalize_c3_motor_control_with_homebrew_SVPWM
  (SFc3_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance);
static void sf_c3_motor_control_with_homebrew_SVPWM
  (SFc3_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance);
static void initSimStructsc3_motor_control_with_homebrew_SVPWM
  (SFc3_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance);
...
static real_T c3_emlrt_marshallIn
  (SFc3_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance, const
   mxArray *c3_pwmc, const char_T *c3_identifier);
...
static real_T c3_mpower(SFc3_motor_control_with_homebrew_SVPWMInstanceStruct
  *chartInstance, real_T c3_a);
static void c3_eml_error(SFc3_motor_control_with_homebrew_SVPWMInstanceStruct
  *chartInstance);
...
static uint8_T c3_e_emlrt_marshallIn
  (SFc3_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance, const
   mxArray *c3_b_is_active_c3_motor_control_with_homebrew_SVPWM, const char_T
   *c3_identifier);
  ...
  (SFc3_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_motor_control_with_homebrew_SVPWM = 0U;
}
  ...
  (SFc3_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance)
{
  ...
  c3_d_hoistedGlobal =
    chartInstance->c3_is_active_c3_motor_control_with_homebrew_SVPWM;
   ...
   mxArray *c3_st)
{
  ...
  *c3_pwmc = c3_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u,
  ...
  chartInstance->c3_is_active_c3_motor_control_with_homebrew_SVPWM =
    ...
    "is_active_c3_motor_control_with_homebrew_SVPWM");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_motor_control_with_homebrew_SVPWM(chartInstance);
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance;
  chartInstance = (SFc3_motor_control_with_homebrew_SVPWMInstanceStruct *)
    chartInstanceVoid;
   ...
   *c3_identifier)
{
  ...
  c3_y = c3_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_motor_control_with_homebrew_SVPWM), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_motor_control_with_homebrew_SVPWM);
  return c3_y;
}
...
/* SFunction Glue Code */
void sf_c3_motor_control_with_homebrew_SVPWM_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c3_motor_control_with_homebrew_SVPWM_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c3_motor_control_with_homebrew_SVPWM
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[5],T\"pwma\",},{M[1],M[12],T\"pwmb\",},{M[1],M[13],T\"pwmc\",},{M[8],M[0],T\"is_active_c3_motor_control_with_homebrew_SVPWM\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_motor_control_with_homebrew_SVPWM_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c3_motor_control_with_homebrew_SVPWM(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc3_motor_control_with_homebrew_SVPWMInstanceStruct*) chartInstanceVar
     )->S,0);
  initialize_params_c3_motor_control_with_homebrew_SVPWM
    ((SFc3_motor_control_with_homebrew_SVPWMInstanceStruct*) chartInstanceVar);
  initialize_c3_motor_control_with_homebrew_SVPWM
    ((SFc3_motor_control_with_homebrew_SVPWMInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c3_motor_control_with_homebrew_SVPWM(void
  *chartInstanceVar)
{
  enable_c3_motor_control_with_homebrew_SVPWM
    ((SFc3_motor_control_with_homebrew_SVPWMInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c3_motor_control_with_homebrew_SVPWM(void
  *chartInstanceVar)
{
  disable_c3_motor_control_with_homebrew_SVPWM
    ((SFc3_motor_control_with_homebrew_SVPWMInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c3_motor_control_with_homebrew_SVPWM(void
  *chartInstanceVar)
{
  sf_c3_motor_control_with_homebrew_SVPWM
    ((SFc3_motor_control_with_homebrew_SVPWMInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c3_motor_control_with_homebrew_SVPWM(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_motor_control_with_homebrew_SVPWM
    ((SFc3_motor_control_with_homebrew_SVPWMInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c3_motor_control_with_homebrew_SVPWM();/* state var info */
...
extern void sf_internal_set_sim_state_c3_motor_control_with_homebrew_SVPWM
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c3_motor_control_with_homebrew_SVPWM
    ((SFc3_motor_control_with_homebrew_SVPWMInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c3_motor_control_with_homebrew_SVPWM(SimStruct* S)
{
  return sf_internal_get_sim_state_c3_motor_control_with_homebrew_SVPWM(S);
}

static void sf_opaque_set_sim_state_c3_motor_control_with_homebrew_SVPWM
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c3_motor_control_with_homebrew_SVPWM(S, st);
}

static void sf_opaque_terminate_c3_motor_control_with_homebrew_SVPWM(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_motor_control_with_homebrew_SVPWMInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c3_motor_control_with_homebrew_SVPWM
      ((SFc3_motor_control_with_homebrew_SVPWMInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc3_motor_control_with_homebrew_SVPWM
    ((SFc3_motor_control_with_homebrew_SVPWMInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_motor_control_with_homebrew_SVPWM(SimStruct *
  S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c3_motor_control_with_homebrew_SVPWM
      ((SFc3_motor_control_with_homebrew_SVPWMInstanceStruct*)(((ChartInfoStruct
          *)ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c3_motor_control_with_homebrew_SVPWM(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c3_motor_control_with_homebrew_SVPWM(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_motor_control_with_homebrew_SVPWM(SimStruct *S)
{
  SFc3_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance;
  chartInstance = (SFc3_motor_control_with_homebrew_SVPWMInstanceStruct *)malloc
    (sizeof(SFc3_motor_control_with_homebrew_SVPWMInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_motor_control_with_homebrew_SVPWM;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_motor_control_with_homebrew_SVPWM;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_motor_control_with_homebrew_SVPWM;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c3_motor_control_with_homebrew_SVPWM;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c3_motor_control_with_homebrew_SVPWM;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_motor_control_with_homebrew_SVPWM;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_motor_control_with_homebrew_SVPWM;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_motor_control_with_homebrew_SVPWM;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_motor_control_with_homebrew_SVPWM;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c3_motor_control_with_homebrew_SVPWM;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_motor_control_with_homebrew_SVPWM;
...
void c3_motor_control_with_homebrew_SVPWM_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_motor_control_with_homebrew_SVPWM(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_motor_control_with_homebrew_SVPWM(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_motor_control_with_homebrew_SVPWM(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_motor_control_with_homebrew_SVPWM_method_dispatcher.\n"
