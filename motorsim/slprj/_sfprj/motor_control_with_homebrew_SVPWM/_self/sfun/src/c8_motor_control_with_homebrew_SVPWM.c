...
static void initialize_c8_motor_control_with_homebrew_SVPWM
  (SFc8_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance);
static void initialize_params_c8_motor_control_with_homebrew_SVPWM
  (SFc8_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance);
static void enable_c8_motor_control_with_homebrew_SVPWM
  (SFc8_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance);
static void disable_c8_motor_control_with_homebrew_SVPWM
  (SFc8_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance);
static void c8_update_debugger_state_c8_motor_control_with_homebrew_SVPWM
  (SFc8_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c8_motor_control_with_homebrew_SVPWM
  (SFc8_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance);
static void set_sim_state_c8_motor_control_with_homebrew_SVPWM
  (SFc8_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance, const
   mxArray *c8_st);
static void finalize_c8_motor_control_with_homebrew_SVPWM
  (SFc8_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance);
static void sf_c8_motor_control_with_homebrew_SVPWM
  (SFc8_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance);
static void c8_chartstep_c8_motor_control_with_homebrew_SVPWM
  (SFc8_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance);
static void initSimStructsc8_motor_control_with_homebrew_SVPWM
  (SFc8_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance);
...
static real_T c8_emlrt_marshallIn
  (SFc8_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance, const
   mxArray *c8_dc2, const char_T *c8_identifier);
...
static real_T c8_angle(SFc8_motor_control_with_homebrew_SVPWMInstanceStruct
  *chartInstance, creal_T c8_h);
static real_T c8_wrapTo2Pi(SFc8_motor_control_with_homebrew_SVPWMInstanceStruct *
  chartInstance, real_T c8_lambda);
static void c8_pol2cart(SFc8_motor_control_with_homebrew_SVPWMInstanceStruct
  *chartInstance, real_T c8_th, real_T c8_r, real_T *c8_x, real_T *c8_y);
...
static uint8_T c8_f_emlrt_marshallIn
  (SFc8_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance, const
   mxArray *c8_b_is_active_c8_motor_control_with_homebrew_SVPWM, const char_T
   *c8_identifier);
  ...
  (SFc8_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance)
{
  ...
  chartInstance->c8_is_active_c8_motor_control_with_homebrew_SVPWM = 0U;
}
  ...
  (SFc8_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance)
{
  ...
  c8_e_hoistedGlobal =
    chartInstance->c8_is_active_c8_motor_control_with_homebrew_SVPWM;
   ...
   mxArray *c8_st)
{
  ...
  *c8_s2 = c8_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c8_u, 3)),
  ...
  chartInstance->c8_is_active_c8_motor_control_with_homebrew_SVPWM =
    ...
    "is_active_c8_motor_control_with_homebrew_SVPWM");
  sf_mex_destroy(&c8_u);
  c8_update_debugger_state_c8_motor_control_with_homebrew_SVPWM(chartInstance);
  ...
  (SFc8_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance)
{
  ...
  chartInstance->c8_sfEvent = CALL_EVENT;
  c8_chartstep_c8_motor_control_with_homebrew_SVPWM(chartInstance);
...
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData)
{
  ...
  const mxArray *c8_y = NULL;
  SFc8_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance;
  chartInstance = (SFc8_motor_control_with_homebrew_SVPWMInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c8_motor_control_with_homebrew_SVPWM_get_eml_resolved_functions_info(void)
{
   ...
   *c8_identifier)
{
  ...
  c8_y = c8_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c8_b_is_active_c8_motor_control_with_homebrew_SVPWM), &c8_thisId);
  sf_mex_destroy(&c8_b_is_active_c8_motor_control_with_homebrew_SVPWM);
  return c8_y;
}
...
/* SFunction Glue Code */
void sf_c8_motor_control_with_homebrew_SVPWM_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c8_motor_control_with_homebrew_SVPWM_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c8_motor_control_with_homebrew_SVPWM
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[9],T\"dc1\",},{M[1],M[10],T\"dc2\",},{M[1],M[5],T\"s1\",},{M[1],M[7],T\"s2\",},{M[8],M[0],T\"is_active_c8_motor_control_with_homebrew_SVPWM\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c8_motor_control_with_homebrew_SVPWM_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c8_motor_control_with_homebrew_SVPWM(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc8_motor_control_with_homebrew_SVPWMInstanceStruct*) chartInstanceVar
     )->S,0);
  initialize_params_c8_motor_control_with_homebrew_SVPWM
    ((SFc8_motor_control_with_homebrew_SVPWMInstanceStruct*) chartInstanceVar);
  initialize_c8_motor_control_with_homebrew_SVPWM
    ((SFc8_motor_control_with_homebrew_SVPWMInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c8_motor_control_with_homebrew_SVPWM(void
  *chartInstanceVar)
{
  enable_c8_motor_control_with_homebrew_SVPWM
    ((SFc8_motor_control_with_homebrew_SVPWMInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c8_motor_control_with_homebrew_SVPWM(void
  *chartInstanceVar)
{
  disable_c8_motor_control_with_homebrew_SVPWM
    ((SFc8_motor_control_with_homebrew_SVPWMInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c8_motor_control_with_homebrew_SVPWM(void
  *chartInstanceVar)
{
  sf_c8_motor_control_with_homebrew_SVPWM
    ((SFc8_motor_control_with_homebrew_SVPWMInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c8_motor_control_with_homebrew_SVPWM(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c8_motor_control_with_homebrew_SVPWM
    ((SFc8_motor_control_with_homebrew_SVPWMInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c8_motor_control_with_homebrew_SVPWM();/* state var info */
...
extern void sf_internal_set_sim_state_c8_motor_control_with_homebrew_SVPWM
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c8_motor_control_with_homebrew_SVPWM
    ((SFc8_motor_control_with_homebrew_SVPWMInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c8_motor_control_with_homebrew_SVPWM(SimStruct* S)
{
  return sf_internal_get_sim_state_c8_motor_control_with_homebrew_SVPWM(S);
}

static void sf_opaque_set_sim_state_c8_motor_control_with_homebrew_SVPWM
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c8_motor_control_with_homebrew_SVPWM(S, st);
}

static void sf_opaque_terminate_c8_motor_control_with_homebrew_SVPWM(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc8_motor_control_with_homebrew_SVPWMInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c8_motor_control_with_homebrew_SVPWM
      ((SFc8_motor_control_with_homebrew_SVPWMInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc8_motor_control_with_homebrew_SVPWM
    ((SFc8_motor_control_with_homebrew_SVPWMInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_motor_control_with_homebrew_SVPWM(SimStruct *
  S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c8_motor_control_with_homebrew_SVPWM
      ((SFc8_motor_control_with_homebrew_SVPWMInstanceStruct*)(((ChartInfoStruct
          *)ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c8_motor_control_with_homebrew_SVPWM(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c8_motor_control_with_homebrew_SVPWM(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c8_motor_control_with_homebrew_SVPWM(SimStruct *S)
{
  SFc8_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance;
  chartInstance = (SFc8_motor_control_with_homebrew_SVPWMInstanceStruct *)malloc
    (sizeof(SFc8_motor_control_with_homebrew_SVPWMInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c8_motor_control_with_homebrew_SVPWM;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c8_motor_control_with_homebrew_SVPWM;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c8_motor_control_with_homebrew_SVPWM;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c8_motor_control_with_homebrew_SVPWM;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c8_motor_control_with_homebrew_SVPWM;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c8_motor_control_with_homebrew_SVPWM;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c8_motor_control_with_homebrew_SVPWM;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c8_motor_control_with_homebrew_SVPWM;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c8_motor_control_with_homebrew_SVPWM;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c8_motor_control_with_homebrew_SVPWM;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c8_motor_control_with_homebrew_SVPWM;
...
void c8_motor_control_with_homebrew_SVPWM_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_motor_control_with_homebrew_SVPWM(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_motor_control_with_homebrew_SVPWM(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_motor_control_with_homebrew_SVPWM(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c8_motor_control_with_homebrew_SVPWM_method_dispatcher.\n"
