...
static const char * c1_debug_family_names[13] = { "L", "R", "Ke", "Kt", "Ides",
  "bemf", "ZL", "nargin", "nargout", "Tdes", "w", "Vd", "Vq" };

/* Function Declarations */
static void initialize_c1_motor_control_with_homebrew_SVPWM
  (SFc1_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance);
static void initialize_params_c1_motor_control_with_homebrew_SVPWM
  (SFc1_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance);
static void enable_c1_motor_control_with_homebrew_SVPWM
  (SFc1_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance);
static void disable_c1_motor_control_with_homebrew_SVPWM
  (SFc1_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_motor_control_with_homebrew_SVPWM
  (SFc1_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_motor_control_with_homebrew_SVPWM
  (SFc1_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance);
static void set_sim_state_c1_motor_control_with_homebrew_SVPWM
  (SFc1_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance, const
   mxArray *c1_st);
static void finalize_c1_motor_control_with_homebrew_SVPWM
  (SFc1_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance);
static void sf_c1_motor_control_with_homebrew_SVPWM
  (SFc1_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance);
static void c1_chartstep_c1_motor_control_with_homebrew_SVPWM
  (SFc1_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance);
static void initSimStructsc1_motor_control_with_homebrew_SVPWM
  (SFc1_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance);
...
static uint8_T c1_d_emlrt_marshallIn
  (SFc1_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance, const
   mxArray *c1_b_is_active_c1_motor_control_with_homebrew_SVPWM, const char_T
   *c1_identifier);
  ...
  (SFc1_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_motor_control_with_homebrew_SVPWM = 0U;
}
  ...
  (SFc1_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance)
{
  ...
  c1_c_hoistedGlobal =
    chartInstance->c1_is_active_c1_motor_control_with_homebrew_SVPWM;
   ...
   mxArray *c1_st)
{
  ...
  *c1_Vq = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 1)),
  ...
  chartInstance->c1_is_active_c1_motor_control_with_homebrew_SVPWM =
    ...
    "is_active_c1_motor_control_with_homebrew_SVPWM");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_motor_control_with_homebrew_SVPWM(chartInstance);
  ...
  (SFc1_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance)
{
  ...
  _SFD_DATA_RANGE_CHECK(*c1_Tdes, 0U);
  _SFD_DATA_RANGE_CHECK(*c1_Vd, 1U);
  _SFD_DATA_RANGE_CHECK(*c1_w, 2U);
  _SFD_DATA_RANGE_CHECK(*c1_Vq, 3U);
  chartInstance->c1_sfEvent = CALL_EVENT;
  c1_chartstep_c1_motor_control_with_homebrew_SVPWM(chartInstance);
  ...
  (SFc1_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance)
{
  ...
  sf_debug_symbol_scope_add_eml_importable(&c1_Ke, 2U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  ...
  c1_b = c1_w;
  c1_bemf = 0.015675059808498339 * c1_b;
  sf_mex_printf("%s =\\n", "bemf");
  c1_b_u = c1_bemf;
  c1_b_y = NULL;
  ...
  c1_b_b = c1_w;
  c1_ZL = 0.0016800892833418108 * c1_b_b;
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance;
  chartInstance = (SFc1_motor_control_with_homebrew_SVPWMInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c1_motor_control_with_homebrew_SVPWM_get_eml_resolved_functions_info(void)
{
  ...
  (*c1_b_info)[6].fileTimeLo = 1286840352U;
  ...
  (*c1_b_info)[7].fileTimeLo = 1305339600U;
  ...
  (*c1_b_info)[8].fileTimeLo = 1286840338U;
  ...
  (*c1_b_info)[9].fileTimeLo = 1325145738U;
   ...
   *c1_identifier)
{
  ...
  c1_y = c1_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_motor_control_with_homebrew_SVPWM), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_motor_control_with_homebrew_SVPWM);
  return c1_y;
}
...
/* SFunction Glue Code */
void sf_c1_motor_control_with_homebrew_SVPWM_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(615036032U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2638716740U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3652274007U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2044932689U);
}

mxArray *sf_c1_motor_control_with_homebrew_SVPWM_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("VgypGoBsFN5GpnLwjqYYGH");
...
static const mxArray *sf_get_sim_state_info_c1_motor_control_with_homebrew_SVPWM
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"Vd\",},{M[1],M[7],T\"Vq\",},{M[8],M[0],T\"is_active_c1_motor_control_with_homebrew_SVPWM\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_motor_control_with_homebrew_SVPWM_get_check_sum(&mxChecksum);
...
{
  return "Q11G4zCe1scistOn8QwgeD";
}

static void sf_opaque_initialize_c1_motor_control_with_homebrew_SVPWM(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc1_motor_control_with_homebrew_SVPWMInstanceStruct*) chartInstanceVar
     )->S,0);
  initialize_params_c1_motor_control_with_homebrew_SVPWM
    ((SFc1_motor_control_with_homebrew_SVPWMInstanceStruct*) chartInstanceVar);
  initialize_c1_motor_control_with_homebrew_SVPWM
    ((SFc1_motor_control_with_homebrew_SVPWMInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_motor_control_with_homebrew_SVPWM(void
  *chartInstanceVar)
{
  enable_c1_motor_control_with_homebrew_SVPWM
    ((SFc1_motor_control_with_homebrew_SVPWMInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_motor_control_with_homebrew_SVPWM(void
  *chartInstanceVar)
{
  disable_c1_motor_control_with_homebrew_SVPWM
    ((SFc1_motor_control_with_homebrew_SVPWMInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_motor_control_with_homebrew_SVPWM(void
  *chartInstanceVar)
{
  sf_c1_motor_control_with_homebrew_SVPWM
    ((SFc1_motor_control_with_homebrew_SVPWMInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c1_motor_control_with_homebrew_SVPWM(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_motor_control_with_homebrew_SVPWM
    ((SFc1_motor_control_with_homebrew_SVPWMInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c1_motor_control_with_homebrew_SVPWM();/* state var info */
...
extern void sf_internal_set_sim_state_c1_motor_control_with_homebrew_SVPWM
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c1_motor_control_with_homebrew_SVPWM
    ((SFc1_motor_control_with_homebrew_SVPWMInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c1_motor_control_with_homebrew_SVPWM(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_motor_control_with_homebrew_SVPWM(S);
}

static void sf_opaque_set_sim_state_c1_motor_control_with_homebrew_SVPWM
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c1_motor_control_with_homebrew_SVPWM(S, st);
}

static void sf_opaque_terminate_c1_motor_control_with_homebrew_SVPWM(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_motor_control_with_homebrew_SVPWMInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c1_motor_control_with_homebrew_SVPWM
      ((SFc1_motor_control_with_homebrew_SVPWMInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_motor_control_with_homebrew_SVPWM
    ((SFc1_motor_control_with_homebrew_SVPWMInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_motor_control_with_homebrew_SVPWM(SimStruct *
  S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c1_motor_control_with_homebrew_SVPWM
      ((SFc1_motor_control_with_homebrew_SVPWMInstanceStruct*)(((ChartInfoStruct
          *)ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c1_motor_control_with_homebrew_SVPWM(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
  ...
  ssSetChecksum0(S,(704217246U));
  ssSetChecksum1(S,(3683398540U));
  ssSetChecksum2(S,(3625905633U));
  ssSetChecksum3(S,(2297007948U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c1_motor_control_with_homebrew_SVPWM(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_motor_control_with_homebrew_SVPWM(SimStruct *S)
{
  SFc1_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance;
  chartInstance = (SFc1_motor_control_with_homebrew_SVPWMInstanceStruct *)malloc
    (sizeof(SFc1_motor_control_with_homebrew_SVPWMInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_motor_control_with_homebrew_SVPWM;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_motor_control_with_homebrew_SVPWM;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_motor_control_with_homebrew_SVPWM;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c1_motor_control_with_homebrew_SVPWM;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_motor_control_with_homebrew_SVPWM;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_motor_control_with_homebrew_SVPWM;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_motor_control_with_homebrew_SVPWM;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_motor_control_with_homebrew_SVPWM;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_motor_control_with_homebrew_SVPWM;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c1_motor_control_with_homebrew_SVPWM;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_motor_control_with_homebrew_SVPWM;
...
void c1_motor_control_with_homebrew_SVPWM_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_motor_control_with_homebrew_SVPWM(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_motor_control_with_homebrew_SVPWM(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_motor_control_with_homebrew_SVPWM(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_motor_control_with_homebrew_SVPWM_method_dispatcher.\n"
