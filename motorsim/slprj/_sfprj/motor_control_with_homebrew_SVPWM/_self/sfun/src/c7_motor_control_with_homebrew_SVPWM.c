...
#include "c7_motor_control_with_homebrew_SVPWM.h"
...
static void initialize_c7_motor_control_with_homebrew_SVPWM
  (SFc7_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance);
static void initialize_params_c7_motor_control_with_homebrew_SVPWM
  (SFc7_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance);
static void enable_c7_motor_control_with_homebrew_SVPWM
  (SFc7_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance);
static void disable_c7_motor_control_with_homebrew_SVPWM
  (SFc7_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance);
static void c7_update_debugger_state_c7_motor_control_with_homebrew_SVPWM
  (SFc7_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c7_motor_control_with_homebrew_SVPWM
  (SFc7_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance);
static void set_sim_state_c7_motor_control_with_homebrew_SVPWM
  (SFc7_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance, const
   mxArray *c7_st);
static void finalize_c7_motor_control_with_homebrew_SVPWM
  (SFc7_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance);
static void sf_c7_motor_control_with_homebrew_SVPWM
  (SFc7_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance);
static void c7_chartstep_c7_motor_control_with_homebrew_SVPWM
  (SFc7_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance);
static void initSimStructsc7_motor_control_with_homebrew_SVPWM
  (SFc7_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance);
...
static real_T c7_emlrt_marshallIn
  (SFc7_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance, const
   mxArray *c7_pc, const char_T *c7_identifier);
...
static uint8_T c7_d_emlrt_marshallIn
  (SFc7_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance, const
   mxArray *c7_b_is_active_c7_motor_control_with_homebrew_SVPWM, const char_T
   *c7_identifier);
  ...
  (SFc7_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance)
{
  ...
  chartInstance->c7_is_active_c7_motor_control_with_homebrew_SVPWM = 0U;
}
  ...
  (SFc7_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance)
{
  ...
  c7_g_hoistedGlobal =
    chartInstance->c7_is_active_c7_motor_control_with_homebrew_SVPWM;
   ...
   mxArray *c7_st)
{
  ...
  *c7_pc = c7_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c7_u, 5)),
    "pc");
  chartInstance->c7_is_active_c7_motor_control_with_homebrew_SVPWM =
    c7_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c7_u, 6)),
    "is_active_c7_motor_control_with_homebrew_SVPWM");
  sf_mex_destroy(&c7_u);
  c7_update_debugger_state_c7_motor_control_with_homebrew_SVPWM(chartInstance);
  ...
  (SFc7_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance)
{
  ...
  chartInstance->c7_sfEvent = CALL_EVENT;
  c7_chartstep_c7_motor_control_with_homebrew_SVPWM(chartInstance);
...
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData)
{
  ...
  const mxArray *c7_y = NULL;
  SFc7_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance;
  chartInstance = (SFc7_motor_control_with_homebrew_SVPWMInstanceStruct *)
    chartInstanceVoid;
   ...
   *c7_identifier)
{
  ...
  c7_y = c7_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c7_b_is_active_c7_motor_control_with_homebrew_SVPWM), &c7_thisId);
  sf_mex_destroy(&c7_b_is_active_c7_motor_control_with_homebrew_SVPWM);
  return c7_y;
}
...
/* SFunction Glue Code */
void sf_c7_motor_control_with_homebrew_SVPWM_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4138508443U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2426351817U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2332400427U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1404345427U);
}

mxArray *sf_c7_motor_control_with_homebrew_SVPWM_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("y6wkJ04ncwKJlu3mteCP7D");
...
static const mxArray *sf_get_sim_state_info_c7_motor_control_with_homebrew_SVPWM
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x7'type','srcId','name','auxInfo'{{M[1],M[5],T\"dca\",},{M[1],M[9],T\"dcb\",},{M[1],M[10],T\"dcc\",},{M[1],M[11],T\"pa\",},{M[1],M[12],T\"pb\",},{M[1],M[13],T\"pc\",},{M[8],M[0],T\"is_active_c7_motor_control_with_homebrew_SVPWM\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 7, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c7_motor_control_with_homebrew_SVPWM_get_check_sum(&mxChecksum);
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1770);
        _SFD_CV_INIT_EML_IF(0,1,0,632,641,697,760);
        _SFD_CV_INIT_EML_IF(0,1,1,799,808,881,961);
        _SFD_CV_INIT_EML_IF(0,1,2,998,1007,1063,1125);
        _SFD_CV_INIT_EML_IF(0,1,3,1164,1175,1248,1328);
        _SFD_CV_INIT_EML_IF(0,1,4,1365,1374,1430,1493);
        _SFD_CV_INIT_EML_IF(0,1,5,1530,1539,1612,1692);

        {
          static int caseStart[] = { 1697, 595, 765, 966, 1130, 1333, 1498 };

          static int caseExprEnd[] = { 1706, 601, 771, 972, 1136, 1339, 1504 };

          _SFD_CV_INIT_EML_SWITCH(0,1,0,575,585,1765,7,&(caseStart[0]),
            &(caseExprEnd[0]));
        }
...
{
  return "HBWDehI9qjCMcne9LDo9AD";
}

static void sf_opaque_initialize_c7_motor_control_with_homebrew_SVPWM(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc7_motor_control_with_homebrew_SVPWMInstanceStruct*) chartInstanceVar
     )->S,0);
  initialize_params_c7_motor_control_with_homebrew_SVPWM
    ((SFc7_motor_control_with_homebrew_SVPWMInstanceStruct*) chartInstanceVar);
  initialize_c7_motor_control_with_homebrew_SVPWM
    ((SFc7_motor_control_with_homebrew_SVPWMInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c7_motor_control_with_homebrew_SVPWM(void
  *chartInstanceVar)
{
  enable_c7_motor_control_with_homebrew_SVPWM
    ((SFc7_motor_control_with_homebrew_SVPWMInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c7_motor_control_with_homebrew_SVPWM(void
  *chartInstanceVar)
{
  disable_c7_motor_control_with_homebrew_SVPWM
    ((SFc7_motor_control_with_homebrew_SVPWMInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c7_motor_control_with_homebrew_SVPWM(void
  *chartInstanceVar)
{
  sf_c7_motor_control_with_homebrew_SVPWM
    ((SFc7_motor_control_with_homebrew_SVPWMInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c7_motor_control_with_homebrew_SVPWM(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c7_motor_control_with_homebrew_SVPWM
    ((SFc7_motor_control_with_homebrew_SVPWMInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c7_motor_control_with_homebrew_SVPWM();/* state var info */
...
extern void sf_internal_set_sim_state_c7_motor_control_with_homebrew_SVPWM
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c7_motor_control_with_homebrew_SVPWM
    ((SFc7_motor_control_with_homebrew_SVPWMInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c7_motor_control_with_homebrew_SVPWM(SimStruct* S)
{
  return sf_internal_get_sim_state_c7_motor_control_with_homebrew_SVPWM(S);
}

static void sf_opaque_set_sim_state_c7_motor_control_with_homebrew_SVPWM
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c7_motor_control_with_homebrew_SVPWM(S, st);
}

static void sf_opaque_terminate_c7_motor_control_with_homebrew_SVPWM(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc7_motor_control_with_homebrew_SVPWMInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c7_motor_control_with_homebrew_SVPWM
      ((SFc7_motor_control_with_homebrew_SVPWMInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc7_motor_control_with_homebrew_SVPWM
    ((SFc7_motor_control_with_homebrew_SVPWMInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c7_motor_control_with_homebrew_SVPWM(SimStruct *
  S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c7_motor_control_with_homebrew_SVPWM
      ((SFc7_motor_control_with_homebrew_SVPWMInstanceStruct*)(((ChartInfoStruct
          *)ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c7_motor_control_with_homebrew_SVPWM(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
  ...
  ssSetChecksum0(S,(988185915U));
  ssSetChecksum1(S,(639365706U));
  ssSetChecksum2(S,(2129236216U));
  ssSetChecksum3(S,(345150969U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c7_motor_control_with_homebrew_SVPWM(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c7_motor_control_with_homebrew_SVPWM(SimStruct *S)
{
  SFc7_motor_control_with_homebrew_SVPWMInstanceStruct *chartInstance;
  chartInstance = (SFc7_motor_control_with_homebrew_SVPWMInstanceStruct *)malloc
    (sizeof(SFc7_motor_control_with_homebrew_SVPWMInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c7_motor_control_with_homebrew_SVPWM;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c7_motor_control_with_homebrew_SVPWM;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c7_motor_control_with_homebrew_SVPWM;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c7_motor_control_with_homebrew_SVPWM;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c7_motor_control_with_homebrew_SVPWM;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c7_motor_control_with_homebrew_SVPWM;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c7_motor_control_with_homebrew_SVPWM;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c7_motor_control_with_homebrew_SVPWM;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c7_motor_control_with_homebrew_SVPWM;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c7_motor_control_with_homebrew_SVPWM;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c7_motor_control_with_homebrew_SVPWM;
...
void c7_motor_control_with_homebrew_SVPWM_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c7_motor_control_with_homebrew_SVPWM(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c7_motor_control_with_homebrew_SVPWM(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c7_motor_control_with_homebrew_SVPWM(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c7_motor_control_with_homebrew_SVPWM_method_dispatcher.\n"
