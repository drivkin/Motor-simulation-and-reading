...
static void initialize_c8_testing_control_with_estimate
  (SFc8_testing_control_with_estimateInstanceStruct *chartInstance);
static void initialize_params_c8_testing_control_with_estimate
  (SFc8_testing_control_with_estimateInstanceStruct *chartInstance);
static void enable_c8_testing_control_with_estimate
  (SFc8_testing_control_with_estimateInstanceStruct *chartInstance);
static void disable_c8_testing_control_with_estimate
  (SFc8_testing_control_with_estimateInstanceStruct *chartInstance);
static void c8_update_debugger_state_c8_testing_control_with_estimate
  (SFc8_testing_control_with_estimateInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c8_testing_control_with_estimate
  (SFc8_testing_control_with_estimateInstanceStruct *chartInstance);
static void set_sim_state_c8_testing_control_with_estimate
  (SFc8_testing_control_with_estimateInstanceStruct *chartInstance, const
   mxArray *c8_st);
static void finalize_c8_testing_control_with_estimate
  (SFc8_testing_control_with_estimateInstanceStruct *chartInstance);
static void sf_c8_testing_control_with_estimate
  (SFc8_testing_control_with_estimateInstanceStruct *chartInstance);
static void c8_chartstep_c8_testing_control_with_estimate
  (SFc8_testing_control_with_estimateInstanceStruct *chartInstance);
static void initSimStructsc8_testing_control_with_estimate
  (SFc8_testing_control_with_estimateInstanceStruct *chartInstance);
...
static real_T c8_angle(SFc8_testing_control_with_estimateInstanceStruct
  *chartInstance, creal_T c8_h);
static real_T c8_wrapTo2Pi(SFc8_testing_control_with_estimateInstanceStruct
  *chartInstance, real_T c8_lambda);
static void c8_pol2cart(SFc8_testing_control_with_estimateInstanceStruct
...
static uint8_T c8_f_emlrt_marshallIn
  (SFc8_testing_control_with_estimateInstanceStruct *chartInstance, const
   mxArray *c8_b_is_active_c8_testing_control_with_estimate, const char_T
   *c8_identifier);
  ...
  (SFc8_testing_control_with_estimateInstanceStruct *chartInstance)
{
  ...
  chartInstance->c8_is_active_c8_testing_control_with_estimate = 0U;
}
  ...
  (SFc8_testing_control_with_estimateInstanceStruct *chartInstance)
{
  ...
  c8_e_hoistedGlobal =
    chartInstance->c8_is_active_c8_testing_control_with_estimate;
   ...
   mxArray *c8_st)
{
  ...
  *c8_s2 = c8_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c8_u, 3)),
  ...
  chartInstance->c8_is_active_c8_testing_control_with_estimate =
    ...
    "is_active_c8_testing_control_with_estimate");
  sf_mex_destroy(&c8_u);
  c8_update_debugger_state_c8_testing_control_with_estimate(chartInstance);
  ...
  (SFc8_testing_control_with_estimateInstanceStruct *chartInstance)
{
  ...
  chartInstance->c8_sfEvent = CALL_EVENT;
  c8_chartstep_c8_testing_control_with_estimate(chartInstance);
...
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData)
{
  ...
  const mxArray *c8_y = NULL;
  SFc8_testing_control_with_estimateInstanceStruct *chartInstance;
  chartInstance = (SFc8_testing_control_with_estimateInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c8_testing_control_with_estimate_get_eml_resolved_functions_info(void)
{
   ...
   *c8_identifier)
{
  ...
  c8_y = c8_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c8_b_is_active_c8_testing_control_with_estimate), &c8_thisId);
  sf_mex_destroy(&c8_b_is_active_c8_testing_control_with_estimate);
  return c8_y;
}
...
/* SFunction Glue Code */
void sf_c8_testing_control_with_estimate_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c8_testing_control_with_estimate_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c8_testing_control_with_estimate
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[9],T\"dc1\",},{M[1],M[10],T\"dc2\",},{M[1],M[5],T\"s1\",},{M[1],M[7],T\"s2\",},{M[8],M[0],T\"is_active_c8_testing_control_with_estimate\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c8_testing_control_with_estimate_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c8_testing_control_with_estimate(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc8_testing_control_with_estimateInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c8_testing_control_with_estimate
    ((SFc8_testing_control_with_estimateInstanceStruct*) chartInstanceVar);
  initialize_c8_testing_control_with_estimate
    ((SFc8_testing_control_with_estimateInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c8_testing_control_with_estimate(void
  *chartInstanceVar)
{
  enable_c8_testing_control_with_estimate
    ((SFc8_testing_control_with_estimateInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c8_testing_control_with_estimate(void
  *chartInstanceVar)
{
  disable_c8_testing_control_with_estimate
    ((SFc8_testing_control_with_estimateInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c8_testing_control_with_estimate(void
  *chartInstanceVar)
{
  sf_c8_testing_control_with_estimate
    ((SFc8_testing_control_with_estimateInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c8_testing_control_with_estimate
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c8_testing_control_with_estimate
    ((SFc8_testing_control_with_estimateInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c8_testing_control_with_estimate();/* state var info */
...
extern void sf_internal_set_sim_state_c8_testing_control_with_estimate(SimStruct*
  S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c8_testing_control_with_estimate
    ((SFc8_testing_control_with_estimateInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c8_testing_control_with_estimate
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c8_testing_control_with_estimate(S);
}

static void sf_opaque_set_sim_state_c8_testing_control_with_estimate(SimStruct*
  S, const mxArray *st)
{
  sf_internal_set_sim_state_c8_testing_control_with_estimate(S, st);
}

static void sf_opaque_terminate_c8_testing_control_with_estimate(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc8_testing_control_with_estimateInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c8_testing_control_with_estimate
      ((SFc8_testing_control_with_estimateInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc8_testing_control_with_estimate
    ((SFc8_testing_control_with_estimateInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_testing_control_with_estimate(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c8_testing_control_with_estimate
      ((SFc8_testing_control_with_estimateInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c8_testing_control_with_estimate(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c8_testing_control_with_estimate(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c8_testing_control_with_estimate(SimStruct *S)
{
  SFc8_testing_control_with_estimateInstanceStruct *chartInstance;
  chartInstance = (SFc8_testing_control_with_estimateInstanceStruct *)malloc
    (sizeof(SFc8_testing_control_with_estimateInstanceStruct));
  memset(chartInstance, 0, sizeof
         (SFc8_testing_control_with_estimateInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c8_testing_control_with_estimate;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c8_testing_control_with_estimate;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c8_testing_control_with_estimate;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c8_testing_control_with_estimate;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c8_testing_control_with_estimate;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c8_testing_control_with_estimate;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c8_testing_control_with_estimate;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c8_testing_control_with_estimate;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c8_testing_control_with_estimate;
  chartInstance->chartInfo.mdlStart = mdlStart_c8_testing_control_with_estimate;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c8_testing_control_with_estimate;
...
void c8_testing_control_with_estimate_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_testing_control_with_estimate(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_testing_control_with_estimate(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_testing_control_with_estimate(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c8_testing_control_with_estimate_method_dispatcher.\n"
