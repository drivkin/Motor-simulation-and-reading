...
static const char * c2_debug_family_names[11] = { "nargin", "nargout", "ha",
  "hb", "hc", "alphaCom", "time", "omega", "theta", "omegaInterp", "tracking" };

/* Function Declarations */
static void initialize_c2_testing_control_with_estimate
  (SFc2_testing_control_with_estimateInstanceStruct *chartInstance);
static void initialize_params_c2_testing_control_with_estimate
  (SFc2_testing_control_with_estimateInstanceStruct *chartInstance);
static void enable_c2_testing_control_with_estimate
  (SFc2_testing_control_with_estimateInstanceStruct *chartInstance);
static void disable_c2_testing_control_with_estimate
  (SFc2_testing_control_with_estimateInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_testing_control_with_estimate
  (SFc2_testing_control_with_estimateInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_testing_control_with_estimate
  (SFc2_testing_control_with_estimateInstanceStruct *chartInstance);
static void set_sim_state_c2_testing_control_with_estimate
  (SFc2_testing_control_with_estimateInstanceStruct *chartInstance, const
   mxArray *c2_st);
static void finalize_c2_testing_control_with_estimate
  (SFc2_testing_control_with_estimateInstanceStruct *chartInstance);
static void sf_c2_testing_control_with_estimate
  (SFc2_testing_control_with_estimateInstanceStruct *chartInstance);
static void initSimStructsc2_testing_control_with_estimate
  (SFc2_testing_control_with_estimateInstanceStruct *chartInstance);
...
static real_T c2_emlrt_marshallIn
  (SFc2_testing_control_with_estimateInstanceStruct *chartInstance, const
   mxArray *c2_omega, const char_T *c2_identifier);
...
static uint8_T c2_d_emlrt_marshallIn
  (SFc2_testing_control_with_estimateInstanceStruct *chartInstance, const
   mxArray *c2_b_is_active_c2_testing_control_with_estimate, const char_T
   *c2_identifier);
  ...
  (SFc2_testing_control_with_estimateInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_testing_control_with_estimate = 0U;
}
  ...
  (SFc2_testing_control_with_estimateInstanceStruct *chartInstance)
{
  ...
  c2_e_hoistedGlobal =
    chartInstance->c2_is_active_c2_testing_control_with_estimate;
   ...
   mxArray *c2_st)
{
  ...
  *c2_tracking = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c2_is_active_c2_testing_control_with_estimate =
    ...
    "is_active_c2_testing_control_with_estimate");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_testing_control_with_estimate(chartInstance);
  ...
  (SFc2_testing_control_with_estimateInstanceStruct *chartInstance)
{
  ...
  sf_mex_call_debug("rotor_estimate", 4U, 5U, 14, c2_y, 14, c2_b_y, 14, c2_c_y,
                    14, c2_d_y, 14, c2_e_y, &c2_m3, &c2_m2, &c2_m1, &c2_m0);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_testing_control_with_estimateInstanceStruct *chartInstance;
  chartInstance = (SFc2_testing_control_with_estimateInstanceStruct *)
    chartInstanceVoid;
   ...
   *c2_identifier)
{
  ...
  c2_y = c2_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_testing_control_with_estimate), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_testing_control_with_estimate);
  return c2_y;
}
...
/* SFunction Glue Code */
void sf_c2_testing_control_with_estimate_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4192186898U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(780842705U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4068844705U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(791579343U);
}

mxArray *sf_c2_testing_control_with_estimate_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("V3MxocKFQaafPCY0TVYUAB");
...
static const mxArray *sf_get_sim_state_info_c2_testing_control_with_estimate
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[8],T\"omega\",},{M[1],M[9],T\"omegaInterp\",},{M[1],M[5],T\"theta\",},{M[1],M[11],T\"tracking\",},{M[8],M[0],T\"is_active_c2_testing_control_with_estimate\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_testing_control_with_estimate_get_check_sum(&mxChecksum);
...
{
  return "sjUwC5WTSe1IUZn9A4tUs";
}

static void sf_opaque_initialize_c2_testing_control_with_estimate(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_testing_control_with_estimateInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_testing_control_with_estimate
    ((SFc2_testing_control_with_estimateInstanceStruct*) chartInstanceVar);
  initialize_c2_testing_control_with_estimate
    ((SFc2_testing_control_with_estimateInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_testing_control_with_estimate(void
  *chartInstanceVar)
{
  enable_c2_testing_control_with_estimate
    ((SFc2_testing_control_with_estimateInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_testing_control_with_estimate(void
  *chartInstanceVar)
{
  disable_c2_testing_control_with_estimate
    ((SFc2_testing_control_with_estimateInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_testing_control_with_estimate(void
  *chartInstanceVar)
{
  sf_c2_testing_control_with_estimate
    ((SFc2_testing_control_with_estimateInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_testing_control_with_estimate
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_testing_control_with_estimate
    ((SFc2_testing_control_with_estimateInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_testing_control_with_estimate();/* state var info */
...
extern void sf_internal_set_sim_state_c2_testing_control_with_estimate(SimStruct*
  S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_testing_control_with_estimate
    ((SFc2_testing_control_with_estimateInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_testing_control_with_estimate
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c2_testing_control_with_estimate(S);
}

static void sf_opaque_set_sim_state_c2_testing_control_with_estimate(SimStruct*
  S, const mxArray *st)
{
  sf_internal_set_sim_state_c2_testing_control_with_estimate(S, st);
}

static void sf_opaque_terminate_c2_testing_control_with_estimate(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_testing_control_with_estimateInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c2_testing_control_with_estimate
      ((SFc2_testing_control_with_estimateInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_testing_control_with_estimate
    ((SFc2_testing_control_with_estimateInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_testing_control_with_estimate(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c2_testing_control_with_estimate
      ((SFc2_testing_control_with_estimateInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_testing_control_with_estimate(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(1127419958U));
  ssSetChecksum1(S,(2963432029U));
  ssSetChecksum2(S,(1570059199U));
  ssSetChecksum3(S,(4179179486U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c2_testing_control_with_estimate(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_testing_control_with_estimate(SimStruct *S)
{
  SFc2_testing_control_with_estimateInstanceStruct *chartInstance;
  chartInstance = (SFc2_testing_control_with_estimateInstanceStruct *)malloc
    (sizeof(SFc2_testing_control_with_estimateInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_testing_control_with_estimate;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_testing_control_with_estimate;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_testing_control_with_estimate;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_testing_control_with_estimate;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_testing_control_with_estimate;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_testing_control_with_estimate;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_testing_control_with_estimate;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_testing_control_with_estimate;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_testing_control_with_estimate;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_testing_control_with_estimate;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_testing_control_with_estimate;
...
void c2_testing_control_with_estimate_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_testing_control_with_estimate(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_testing_control_with_estimate(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_testing_control_with_estimate(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_testing_control_with_estimate_method_dispatcher.\n"
