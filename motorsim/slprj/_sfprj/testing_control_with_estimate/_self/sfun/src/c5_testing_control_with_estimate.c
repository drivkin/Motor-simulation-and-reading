...
static void initialize_c5_testing_control_with_estimate
  (SFc5_testing_control_with_estimateInstanceStruct *chartInstance);
static void initialize_params_c5_testing_control_with_estimate
  (SFc5_testing_control_with_estimateInstanceStruct *chartInstance);
static void enable_c5_testing_control_with_estimate
  (SFc5_testing_control_with_estimateInstanceStruct *chartInstance);
static void disable_c5_testing_control_with_estimate
  (SFc5_testing_control_with_estimateInstanceStruct *chartInstance);
static void c5_update_debugger_state_c5_testing_control_with_estimate
  (SFc5_testing_control_with_estimateInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c5_testing_control_with_estimate
  (SFc5_testing_control_with_estimateInstanceStruct *chartInstance);
static void set_sim_state_c5_testing_control_with_estimate
  (SFc5_testing_control_with_estimateInstanceStruct *chartInstance, const
   mxArray *c5_st);
static void finalize_c5_testing_control_with_estimate
  (SFc5_testing_control_with_estimateInstanceStruct *chartInstance);
static void sf_c5_testing_control_with_estimate
  (SFc5_testing_control_with_estimateInstanceStruct *chartInstance);
static void c5_chartstep_c5_testing_control_with_estimate
  (SFc5_testing_control_with_estimateInstanceStruct *chartInstance);
static void initSimStructsc5_testing_control_with_estimate
  (SFc5_testing_control_with_estimateInstanceStruct *chartInstance);
...
static uint8_T c5_e_emlrt_marshallIn
  (SFc5_testing_control_with_estimateInstanceStruct *chartInstance, const
   mxArray *c5_b_is_active_c5_testing_control_with_estimate, const char_T
   *c5_identifier);
  ...
  (SFc5_testing_control_with_estimateInstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_testing_control_with_estimate = 0U;
}
  ...
  (SFc5_testing_control_with_estimateInstanceStruct *chartInstance)
{
  ...
  c5_b_hoistedGlobal =
    chartInstance->c5_is_active_c5_testing_control_with_estimate;
   ...
   mxArray *c5_st)
{
  ...
  *c5_lambda1 = c5_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c5_is_active_c5_testing_control_with_estimate =
    ...
    "is_active_c5_testing_control_with_estimate");
  sf_mex_destroy(&c5_u);
  c5_update_debugger_state_c5_testing_control_with_estimate(chartInstance);
  ...
  (SFc5_testing_control_with_estimateInstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_sfEvent = CALL_EVENT;
  c5_chartstep_c5_testing_control_with_estimate(chartInstance);
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  const mxArray *c5_y = NULL;
  SFc5_testing_control_with_estimateInstanceStruct *chartInstance;
  chartInstance = (SFc5_testing_control_with_estimateInstanceStruct *)
    chartInstanceVoid;
   ...
   *c5_identifier)
{
  ...
  c5_y = c5_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c5_b_is_active_c5_testing_control_with_estimate), &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_testing_control_with_estimate);
  return c5_y;
}
...
/* SFunction Glue Code */
void sf_c5_testing_control_with_estimate_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c5_testing_control_with_estimate_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c5_testing_control_with_estimate
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"lambda1\",},{M[8],M[0],T\"is_active_c5_testing_control_with_estimate\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_testing_control_with_estimate_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c5_testing_control_with_estimate(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc5_testing_control_with_estimateInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c5_testing_control_with_estimate
    ((SFc5_testing_control_with_estimateInstanceStruct*) chartInstanceVar);
  initialize_c5_testing_control_with_estimate
    ((SFc5_testing_control_with_estimateInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c5_testing_control_with_estimate(void
  *chartInstanceVar)
{
  enable_c5_testing_control_with_estimate
    ((SFc5_testing_control_with_estimateInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c5_testing_control_with_estimate(void
  *chartInstanceVar)
{
  disable_c5_testing_control_with_estimate
    ((SFc5_testing_control_with_estimateInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c5_testing_control_with_estimate(void
  *chartInstanceVar)
{
  sf_c5_testing_control_with_estimate
    ((SFc5_testing_control_with_estimateInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c5_testing_control_with_estimate
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c5_testing_control_with_estimate
    ((SFc5_testing_control_with_estimateInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c5_testing_control_with_estimate();/* state var info */
...
extern void sf_internal_set_sim_state_c5_testing_control_with_estimate(SimStruct*
  S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c5_testing_control_with_estimate
    ((SFc5_testing_control_with_estimateInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c5_testing_control_with_estimate
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c5_testing_control_with_estimate(S);
}

static void sf_opaque_set_sim_state_c5_testing_control_with_estimate(SimStruct*
  S, const mxArray *st)
{
  sf_internal_set_sim_state_c5_testing_control_with_estimate(S, st);
}

static void sf_opaque_terminate_c5_testing_control_with_estimate(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_testing_control_with_estimateInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c5_testing_control_with_estimate
      ((SFc5_testing_control_with_estimateInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc5_testing_control_with_estimate
    ((SFc5_testing_control_with_estimateInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_testing_control_with_estimate(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c5_testing_control_with_estimate
      ((SFc5_testing_control_with_estimateInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c5_testing_control_with_estimate(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c5_testing_control_with_estimate(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_testing_control_with_estimate(SimStruct *S)
{
  SFc5_testing_control_with_estimateInstanceStruct *chartInstance;
  chartInstance = (SFc5_testing_control_with_estimateInstanceStruct *)malloc
    (sizeof(SFc5_testing_control_with_estimateInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c5_testing_control_with_estimate;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c5_testing_control_with_estimate;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c5_testing_control_with_estimate;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c5_testing_control_with_estimate;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c5_testing_control_with_estimate;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c5_testing_control_with_estimate;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c5_testing_control_with_estimate;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c5_testing_control_with_estimate;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_testing_control_with_estimate;
  chartInstance->chartInfo.mdlStart = mdlStart_c5_testing_control_with_estimate;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c5_testing_control_with_estimate;
...
void c5_testing_control_with_estimate_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_testing_control_with_estimate(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_testing_control_with_estimate(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_testing_control_with_estimate(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_testing_control_with_estimate_method_dispatcher.\n"
