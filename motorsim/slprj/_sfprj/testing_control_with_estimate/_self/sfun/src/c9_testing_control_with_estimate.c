...
static void initialize_c9_testing_control_with_estimate
  (SFc9_testing_control_with_estimateInstanceStruct *chartInstance);
static void initialize_params_c9_testing_control_with_estimate
  (SFc9_testing_control_with_estimateInstanceStruct *chartInstance);
static void enable_c9_testing_control_with_estimate
  (SFc9_testing_control_with_estimateInstanceStruct *chartInstance);
static void disable_c9_testing_control_with_estimate
  (SFc9_testing_control_with_estimateInstanceStruct *chartInstance);
static void c9_update_debugger_state_c9_testing_control_with_estimate
  (SFc9_testing_control_with_estimateInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c9_testing_control_with_estimate
  (SFc9_testing_control_with_estimateInstanceStruct *chartInstance);
static void set_sim_state_c9_testing_control_with_estimate
  (SFc9_testing_control_with_estimateInstanceStruct *chartInstance, const
   mxArray *c9_st);
static void finalize_c9_testing_control_with_estimate
  (SFc9_testing_control_with_estimateInstanceStruct *chartInstance);
static void sf_c9_testing_control_with_estimate
  (SFc9_testing_control_with_estimateInstanceStruct *chartInstance);
static void initSimStructsc9_testing_control_with_estimate
  (SFc9_testing_control_with_estimateInstanceStruct *chartInstance);
...
static real_T c9_emlrt_marshallIn
  (SFc9_testing_control_with_estimateInstanceStruct *chartInstance, const
   mxArray *c9_Vc, const char_T *c9_identifier);
...
static uint8_T c9_e_emlrt_marshallIn
  (SFc9_testing_control_with_estimateInstanceStruct *chartInstance, const
   mxArray *c9_b_is_active_c9_testing_control_with_estimate, const char_T
   *c9_identifier);
  ...
  (SFc9_testing_control_with_estimateInstanceStruct *chartInstance)
{
  ...
  chartInstance->c9_is_active_c9_testing_control_with_estimate = 0U;
}
   ...
   *c9_identifier)
{
  ...
  c9_y = c9_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c9_b_is_active_c9_testing_control_with_estimate), &c9_thisId);
  sf_mex_destroy(&c9_b_is_active_c9_testing_control_with_estimate);
  return c9_y;
}
...
/* SFunction Glue Code */
void sf_c9_testing_control_with_estimate_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c9_testing_control_with_estimate_get_autoinheritance_info(void)
{
...
static void sf_opaque_initialize_c9_testing_control_with_estimate(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc9_testing_control_with_estimateInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c9_testing_control_with_estimate
    ((SFc9_testing_control_with_estimateInstanceStruct*) chartInstanceVar);
  initialize_c9_testing_control_with_estimate
    ((SFc9_testing_control_with_estimateInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c9_testing_control_with_estimate(void
  *chartInstanceVar)
{
  enable_c9_testing_control_with_estimate
    ((SFc9_testing_control_with_estimateInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c9_testing_control_with_estimate(void
  *chartInstanceVar)
{
  disable_c9_testing_control_with_estimate
    ((SFc9_testing_control_with_estimateInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c9_testing_control_with_estimate(void
  *chartInstanceVar)
{
  sf_c9_testing_control_with_estimate
    ((SFc9_testing_control_with_estimateInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c9_testing_control_with_estimate
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c9_testing_control_with_estimate
    ((SFc9_testing_control_with_estimateInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c9_testing_control_with_estimate();/* state var info */
...
extern void sf_internal_set_sim_state_c9_testing_control_with_estimate(SimStruct*
  S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c9_testing_control_with_estimate
    ((SFc9_testing_control_with_estimateInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c9_testing_control_with_estimate
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c9_testing_control_with_estimate(S);
}

static void sf_opaque_set_sim_state_c9_testing_control_with_estimate(SimStruct*
  S, const mxArray *st)
{
  sf_internal_set_sim_state_c9_testing_control_with_estimate(S, st);
}

static void sf_opaque_terminate_c9_testing_control_with_estimate(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc9_testing_control_with_estimateInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c9_testing_control_with_estimate
      ((SFc9_testing_control_with_estimateInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc9_testing_control_with_estimate
    ((SFc9_testing_control_with_estimateInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c9_testing_control_with_estimate(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c9_testing_control_with_estimate
      ((SFc9_testing_control_with_estimateInstanceStruct*)(((ChartInfoStruct *)
...
static void mdlRTW_c9_testing_control_with_estimate(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
void c9_testing_control_with_estimate_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c9_testing_control_with_estimate(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c9_testing_control_with_estimate(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c9_testing_control_with_estimate(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c9_testing_control_with_estimate_method_dispatcher.\n"
