...
static void initialize_c6_testing_control_with_estimate
  (SFc6_testing_control_with_estimateInstanceStruct *chartInstance);
static void initialize_params_c6_testing_control_with_estimate
  (SFc6_testing_control_with_estimateInstanceStruct *chartInstance);
static void enable_c6_testing_control_with_estimate
  (SFc6_testing_control_with_estimateInstanceStruct *chartInstance);
static void disable_c6_testing_control_with_estimate
  (SFc6_testing_control_with_estimateInstanceStruct *chartInstance);
static void c6_update_debugger_state_c6_testing_control_with_estimate
  (SFc6_testing_control_with_estimateInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c6_testing_control_with_estimate
  (SFc6_testing_control_with_estimateInstanceStruct *chartInstance);
static void set_sim_state_c6_testing_control_with_estimate
  (SFc6_testing_control_with_estimateInstanceStruct *chartInstance, const
   mxArray *c6_st);
static void finalize_c6_testing_control_with_estimate
  (SFc6_testing_control_with_estimateInstanceStruct *chartInstance);
static void sf_c6_testing_control_with_estimate
  (SFc6_testing_control_with_estimateInstanceStruct *chartInstance);
static void c6_chartstep_c6_testing_control_with_estimate
  (SFc6_testing_control_with_estimateInstanceStruct *chartInstance);
static void initSimStructsc6_testing_control_with_estimate
  (SFc6_testing_control_with_estimateInstanceStruct *chartInstance);
...
static void c6_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static void c6_eml_scalar_eg(SFc6_testing_control_with_estimateInstanceStruct
  *chartInstance);
...
static uint8_T c6_f_emlrt_marshallIn
  (SFc6_testing_control_with_estimateInstanceStruct *chartInstance, const
   mxArray *c6_b_is_active_c6_testing_control_with_estimate, const char_T
   *c6_identifier);
  ...
  (SFc6_testing_control_with_estimateInstanceStruct *chartInstance)
{
  ...
  chartInstance->c6_is_active_c6_testing_control_with_estimate = 0U;
}
  ...
  (SFc6_testing_control_with_estimateInstanceStruct *chartInstance)
{
  ...
  c6_c_hoistedGlobal =
    chartInstance->c6_is_active_c6_testing_control_with_estimate;
   ...
   mxArray *c6_st)
{
  ...
  *c6_Xbeta = c6_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c6_u,
  ...
  chartInstance->c6_is_active_c6_testing_control_with_estimate =
    ...
    "is_active_c6_testing_control_with_estimate");
  sf_mex_destroy(&c6_u);
  c6_update_debugger_state_c6_testing_control_with_estimate(chartInstance);
  ...
  (SFc6_testing_control_with_estimateInstanceStruct *chartInstance)
{
  ...
  chartInstance->c6_sfEvent = CALL_EVENT;
  c6_chartstep_c6_testing_control_with_estimate(chartInstance);
...
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData)
{
  ...
  const mxArray *c6_y = NULL;
  SFc6_testing_control_with_estimateInstanceStruct *chartInstance;
  chartInstance = (SFc6_testing_control_with_estimateInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c6_testing_control_with_estimate_get_eml_resolved_functions_info(void)
{
   ...
   *c6_identifier)
{
  ...
  c6_y = c6_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c6_b_is_active_c6_testing_control_with_estimate), &c6_thisId);
  sf_mex_destroy(&c6_b_is_active_c6_testing_control_with_estimate);
  return c6_y;
}
...
/* SFunction Glue Code */
void sf_c6_testing_control_with_estimate_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c6_testing_control_with_estimate_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c6_testing_control_with_estimate
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"Xalpha\",},{M[1],M[8],T\"Xbeta\",},{M[8],M[0],T\"is_active_c6_testing_control_with_estimate\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c6_testing_control_with_estimate_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c6_testing_control_with_estimate(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc6_testing_control_with_estimateInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c6_testing_control_with_estimate
    ((SFc6_testing_control_with_estimateInstanceStruct*) chartInstanceVar);
  initialize_c6_testing_control_with_estimate
    ((SFc6_testing_control_with_estimateInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c6_testing_control_with_estimate(void
  *chartInstanceVar)
{
  enable_c6_testing_control_with_estimate
    ((SFc6_testing_control_with_estimateInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c6_testing_control_with_estimate(void
  *chartInstanceVar)
{
  disable_c6_testing_control_with_estimate
    ((SFc6_testing_control_with_estimateInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c6_testing_control_with_estimate(void
  *chartInstanceVar)
{
  sf_c6_testing_control_with_estimate
    ((SFc6_testing_control_with_estimateInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c6_testing_control_with_estimate
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c6_testing_control_with_estimate
    ((SFc6_testing_control_with_estimateInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c6_testing_control_with_estimate();/* state var info */
...
extern void sf_internal_set_sim_state_c6_testing_control_with_estimate(SimStruct*
  S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c6_testing_control_with_estimate
    ((SFc6_testing_control_with_estimateInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c6_testing_control_with_estimate
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c6_testing_control_with_estimate(S);
}

static void sf_opaque_set_sim_state_c6_testing_control_with_estimate(SimStruct*
  S, const mxArray *st)
{
  sf_internal_set_sim_state_c6_testing_control_with_estimate(S, st);
}

static void sf_opaque_terminate_c6_testing_control_with_estimate(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc6_testing_control_with_estimateInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c6_testing_control_with_estimate
      ((SFc6_testing_control_with_estimateInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc6_testing_control_with_estimate
    ((SFc6_testing_control_with_estimateInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c6_testing_control_with_estimate(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c6_testing_control_with_estimate
      ((SFc6_testing_control_with_estimateInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c6_testing_control_with_estimate(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c6_testing_control_with_estimate(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c6_testing_control_with_estimate(SimStruct *S)
{
  SFc6_testing_control_with_estimateInstanceStruct *chartInstance;
  chartInstance = (SFc6_testing_control_with_estimateInstanceStruct *)malloc
    (sizeof(SFc6_testing_control_with_estimateInstanceStruct));
  memset(chartInstance, 0, sizeof
         (SFc6_testing_control_with_estimateInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c6_testing_control_with_estimate;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c6_testing_control_with_estimate;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c6_testing_control_with_estimate;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c6_testing_control_with_estimate;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c6_testing_control_with_estimate;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c6_testing_control_with_estimate;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c6_testing_control_with_estimate;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c6_testing_control_with_estimate;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c6_testing_control_with_estimate;
  chartInstance->chartInfo.mdlStart = mdlStart_c6_testing_control_with_estimate;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c6_testing_control_with_estimate;
...
void c6_testing_control_with_estimate_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c6_testing_control_with_estimate(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c6_testing_control_with_estimate(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c6_testing_control_with_estimate(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c6_testing_control_with_estimate_method_dispatcher.\n"
