...
static void initialize_c9_testing_Control(SFc9_testing_ControlInstanceStruct
  *chartInstance);
static void initialize_params_c9_testing_Control
  (SFc9_testing_ControlInstanceStruct *chartInstance);
static void enable_c9_testing_Control(SFc9_testing_ControlInstanceStruct
  *chartInstance);
static void disable_c9_testing_Control(SFc9_testing_ControlInstanceStruct
  *chartInstance);
static void c9_update_debugger_state_c9_testing_Control
  (SFc9_testing_ControlInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c9_testing_Control
  (SFc9_testing_ControlInstanceStruct *chartInstance);
static void set_sim_state_c9_testing_Control(SFc9_testing_ControlInstanceStruct *
  chartInstance, const mxArray *c9_st);
static void finalize_c9_testing_Control(SFc9_testing_ControlInstanceStruct
  *chartInstance);
static void sf_c9_testing_Control(SFc9_testing_ControlInstanceStruct
  *chartInstance);
static void initSimStructsc9_testing_Control(SFc9_testing_ControlInstanceStruct *
  chartInstance);
static void init_script_number_translation(uint32_T c9_machineNumber, uint32_T
  c9_chartNumber);
static const mxArray *c9_sf_marshallOut(void *chartInstanceVoid, void *c9_inData);
static real_T c9_emlrt_marshallIn(SFc9_testing_ControlInstanceStruct
  *chartInstance, const mxArray *c9_Vc, const char_T *c9_identifier);
static real_T c9_b_emlrt_marshallIn(SFc9_testing_ControlInstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
static void c9_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c9_mxArrayInData, const char_T *c9_varName, void *c9_outData);
static const mxArray *c9_b_sf_marshallOut(void *chartInstanceVoid, void
  *c9_inData);
static void c9_c_emlrt_marshallIn(SFc9_testing_ControlInstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId,
  real_T c9_y[3]);
...
static const mxArray *c9_c_sf_marshallOut(void *chartInstanceVoid, void
  *c9_inData);
static int32_T c9_d_emlrt_marshallIn(SFc9_testing_ControlInstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
static void c9_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c9_mxArrayInData, const char_T *c9_varName, void *c9_outData);
static uint8_T c9_e_emlrt_marshallIn(SFc9_testing_ControlInstanceStruct
  *chartInstance, const mxArray *c9_b_is_active_c9_testing_Control, const char_T
  *c9_identifier);
static uint8_T c9_f_emlrt_marshallIn(SFc9_testing_ControlInstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
static void init_dsm_address_info(SFc9_testing_ControlInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c9_is_active_c9_testing_Control = 0U;
}
  ...
  (SFc9_testing_ControlInstanceStruct *chartInstance)
{
  ...
  c9_d_hoistedGlobal = chartInstance->c9_is_active_c9_testing_Control;
  ...
  chartInstance, const mxArray *c9_st)
{
  ...
  *c9_Vc = c9_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c9_u, 2)),
    "Vc");
  chartInstance->c9_is_active_c9_testing_Control = c9_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c9_u, 3)),
     "is_active_c9_testing_Control");
  sf_mex_destroy(&c9_u);
  c9_update_debugger_state_c9_testing_Control(chartInstance);
   ...
   case 6:
    ...
    if (CV_EML_IF(0, 1, 5, c9_s2 == 1.0)) {
      ...
      for (c9_i3 = 0; c9_i3 < 3; c9_i3++) {
        c9_c_u[c9_i3] = c9_dc[c9_i3];
      }

      c9_c_y = NULL;
      sf_mex_assign(&c9_c_y, sf_mex_create("y", c9_c_u, 0, 0U, 1U, 0U, 2, 1, 3),
                    FALSE);
      sf_mex_call_debug("disp", 0U, 1U, 14, c9_c_y);
    }
    break;
...
static const mxArray *c9_sf_marshallOut(void *chartInstanceVoid, void *c9_inData)
{
  ...
  const mxArray *c9_y = NULL;
  SFc9_testing_ControlInstanceStruct *chartInstance;
  chartInstance = (SFc9_testing_ControlInstanceStruct *)chartInstanceVoid;
  ...
  *c9_mxArrayInData, const char_T *c9_varName, void *c9_outData)
{
  ...
  for (c9_i7 = 0; c9_i7 < 3; c9_i7++) {
    (*(real_T (*)[3])c9_outData)[c9_i7] = c9_y[c9_i7];
  }

  sf_mex_destroy(&c9_mxArrayInData);
}

const mxArray *sf_c9_testing_Control_get_eml_resolved_functions_info(void)
{
  ...
  for (c9_i8 = 0; c9_i8 < 1; c9_i8++) {
    ...
    sf_mex_addfield(c9_m0, sf_mex_create("nameCaptureInfo", c9_r0->name, 15, 0U,
      0U, 0U, 2, 1, strlen(c9_r0->name)), "name", "nameCaptureInfo", c9_i8);
  ...
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId)
{
  int32_T c9_y;
  int32_T c9_i9;
  sf_mex_import(c9_parentId, sf_mex_dup(c9_u), &c9_i9, 1, 6, 0U, 0, 0U, 0);
  c9_y = c9_i9;
  sf_mex_destroy(&c9_u);
  return c9_y;
}
  ...
  *c9_identifier)
{
  ...
  c9_y = c9_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c9_b_is_active_c9_testing_Control), &c9_thisId);
  sf_mex_destroy(&c9_b_is_active_c9_testing_Control);
  return c9_y;
}
...
/* SFunction Glue Code */
void sf_c9_testing_Control_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(835230943U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(587012939U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(36533418U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1808914257U);
}

mxArray *sf_c9_testing_Control_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("20tQ8Vgu2aSDbBrlbe3cqD");
...
static const mxArray *sf_get_sim_state_info_c9_testing_Control(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[5],T\"Va\",},{M[1],M[9],T\"Vb\",},{M[1],M[10],T\"Vc\",},{M[8],M[0],T\"is_active_c9_testing_Control\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c9_testing_Control_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc9_testing_ControlInstanceStruct *chartInstance;
    chartInstance = (SFc9_testing_ControlInstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1285);
        _SFD_CV_INIT_EML_IF(0,1,0,490,499,540,590);
        _SFD_CV_INIT_EML_IF(0,1,1,610,619,662,712);
        _SFD_CV_INIT_EML_IF(0,1,2,732,741,784,834);
        _SFD_CV_INIT_EML_IF(0,1,3,854,865,908,957);
        _SFD_CV_INIT_EML_IF(0,1,4,977,986,1029,1078);
        _SFD_CV_INIT_EML_IF(0,1,5,1107,1116,1159,1208);

        {
          static int caseStart[] = { 1213, 475, 595, 717, 839, 962, 1083 };

          static int caseExprEnd[] = { 1222, 481, 601, 723, 845, 968, 1089 };

          _SFD_CV_INIT_EML_SWITCH(0,1,0,455,465,1235,7,&(caseStart[0]),
            &(caseExprEnd[0]));
        }
...
{
  return "J4mHJcedKyiUZM1x3uiD7";
}

static void sf_opaque_initialize_c9_testing_Control(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc9_testing_ControlInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c9_testing_Control((SFc9_testing_ControlInstanceStruct*)
    chartInstanceVar);
  initialize_c9_testing_Control((SFc9_testing_ControlInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c9_testing_Control(void *chartInstanceVar)
{
  enable_c9_testing_Control((SFc9_testing_ControlInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c9_testing_Control(void *chartInstanceVar)
{
  disable_c9_testing_Control((SFc9_testing_ControlInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c9_testing_Control(void *chartInstanceVar)
{
  sf_c9_testing_Control((SFc9_testing_ControlInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c9_testing_Control(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c9_testing_Control
    ((SFc9_testing_ControlInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c9_testing_Control();/* state var info */
...
extern void sf_internal_set_sim_state_c9_testing_Control(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c9_testing_Control((SFc9_testing_ControlInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c9_testing_Control(SimStruct* S)
{
  return sf_internal_get_sim_state_c9_testing_Control(S);
}

static void sf_opaque_set_sim_state_c9_testing_Control(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c9_testing_Control(S, st);
}

static void sf_opaque_terminate_c9_testing_Control(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc9_testing_ControlInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c9_testing_Control((SFc9_testing_ControlInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc9_testing_Control((SFc9_testing_ControlInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c9_testing_Control(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c9_testing_Control(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(4293941941U));
  ssSetChecksum1(S,(2223673500U));
  ssSetChecksum2(S,(3958179534U));
  ssSetChecksum3(S,(600817811U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c9_testing_Control(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c9_testing_Control(SimStruct *S)
{
  SFc9_testing_ControlInstanceStruct *chartInstance;
  chartInstance = (SFc9_testing_ControlInstanceStruct *)malloc(sizeof
    (SFc9_testing_ControlInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc9_testing_ControlInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c9_testing_Control;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c9_testing_Control;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c9_testing_Control;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c9_testing_Control;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c9_testing_Control;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c9_testing_Control;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c9_testing_Control;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c9_testing_Control;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c9_testing_Control;
  chartInstance->chartInfo.mdlStart = mdlStart_c9_testing_Control;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c9_testing_Control;
...
void c9_testing_Control_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c9_testing_Control(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c9_testing_Control(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c9_testing_Control(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c9_testing_Control_method_dispatcher.\n"
