...
static void initialize_c5_testing_Control(SFc5_testing_ControlInstanceStruct
  *chartInstance);
static void initialize_params_c5_testing_Control
  (SFc5_testing_ControlInstanceStruct *chartInstance);
static void enable_c5_testing_Control(SFc5_testing_ControlInstanceStruct
  *chartInstance);
static void disable_c5_testing_Control(SFc5_testing_ControlInstanceStruct
  *chartInstance);
static void c5_update_debugger_state_c5_testing_Control
  (SFc5_testing_ControlInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c5_testing_Control
  (SFc5_testing_ControlInstanceStruct *chartInstance);
static void set_sim_state_c5_testing_Control(SFc5_testing_ControlInstanceStruct *
  chartInstance, const mxArray *c5_st);
static void finalize_c5_testing_Control(SFc5_testing_ControlInstanceStruct
  *chartInstance);
...
static void c5_chartstep_c5_testing_Control(SFc5_testing_ControlInstanceStruct
  *chartInstance);
static void initSimStructsc5_testing_Control(SFc5_testing_ControlInstanceStruct *
  chartInstance);
static void init_script_number_translation(uint32_T c5_machineNumber, uint32_T
  c5_chartNumber);
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData);
static real_T c5_emlrt_marshallIn(SFc5_testing_ControlInstanceStruct
  *chartInstance, const mxArray *c5_lambda1, const char_T *c5_identifier);
static real_T c5_b_emlrt_marshallIn(SFc5_testing_ControlInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static const mxArray *c5_b_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static boolean_T c5_c_emlrt_marshallIn(SFc5_testing_ControlInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
...
static const mxArray *c5_c_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static int32_T c5_d_emlrt_marshallIn(SFc5_testing_ControlInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static uint8_T c5_e_emlrt_marshallIn(SFc5_testing_ControlInstanceStruct
  *chartInstance, const mxArray *c5_b_is_active_c5_testing_Control, const char_T
  *c5_identifier);
static uint8_T c5_f_emlrt_marshallIn(SFc5_testing_ControlInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void init_dsm_address_info(SFc5_testing_ControlInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_testing_Control = 0U;
}
  ...
  (SFc5_testing_ControlInstanceStruct *chartInstance)
{
  ...
  c5_b_hoistedGlobal = chartInstance->c5_is_active_c5_testing_Control;
  ...
  *c5_identifier)
{
  ...
  c5_y = c5_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c5_b_is_active_c5_testing_Control), &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_testing_Control);
  return c5_y;
}
...
/* SFunction Glue Code */
void sf_c5_testing_Control_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c5_testing_Control_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c5_testing_Control(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"lambda1\",},{M[8],M[0],T\"is_active_c5_testing_Control\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_testing_Control_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc5_testing_ControlInstanceStruct *chartInstance;
    chartInstance = (SFc5_testing_ControlInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c5_testing_Control(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc5_testing_ControlInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c5_testing_Control((SFc5_testing_ControlInstanceStruct*)
    chartInstanceVar);
  initialize_c5_testing_Control((SFc5_testing_ControlInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c5_testing_Control(void *chartInstanceVar)
{
  enable_c5_testing_Control((SFc5_testing_ControlInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c5_testing_Control(void *chartInstanceVar)
{
  disable_c5_testing_Control((SFc5_testing_ControlInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c5_testing_Control(void *chartInstanceVar)
{
  sf_c5_testing_Control((SFc5_testing_ControlInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c5_testing_Control(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c5_testing_Control
    ((SFc5_testing_ControlInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c5_testing_Control();/* state var info */
...
extern void sf_internal_set_sim_state_c5_testing_Control(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c5_testing_Control((SFc5_testing_ControlInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c5_testing_Control(SimStruct* S)
{
  return sf_internal_get_sim_state_c5_testing_Control(S);
}

static void sf_opaque_set_sim_state_c5_testing_Control(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c5_testing_Control(S, st);
}

static void sf_opaque_terminate_c5_testing_Control(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_testing_ControlInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c5_testing_Control((SFc5_testing_ControlInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc5_testing_Control((SFc5_testing_ControlInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_testing_Control(SimStruct *S)
{
  int i;
...
static void mdlRTW_c5_testing_Control(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_testing_Control(SimStruct *S)
{
  SFc5_testing_ControlInstanceStruct *chartInstance;
  chartInstance = (SFc5_testing_ControlInstanceStruct *)malloc(sizeof
    (SFc5_testing_ControlInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc5_testing_ControlInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c5_testing_Control;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c5_testing_Control;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c5_testing_Control;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c5_testing_Control;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c5_testing_Control;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c5_testing_Control;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c5_testing_Control;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c5_testing_Control;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_testing_Control;
  chartInstance->chartInfo.mdlStart = mdlStart_c5_testing_Control;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c5_testing_Control;
...
void c5_testing_Control_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_testing_Control(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_testing_Control(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_testing_Control(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_testing_Control_method_dispatcher.\n"
