...
#include "testing_Control_sfun_debug_macros.h"
...
static void initialize_c8_testing_Control(SFc8_testing_ControlInstanceStruct
  *chartInstance);
static void initialize_params_c8_testing_Control
  (SFc8_testing_ControlInstanceStruct *chartInstance);
static void enable_c8_testing_Control(SFc8_testing_ControlInstanceStruct
  *chartInstance);
static void disable_c8_testing_Control(SFc8_testing_ControlInstanceStruct
  *chartInstance);
static void c8_update_debugger_state_c8_testing_Control
  (SFc8_testing_ControlInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c8_testing_Control
  (SFc8_testing_ControlInstanceStruct *chartInstance);
static void set_sim_state_c8_testing_Control(SFc8_testing_ControlInstanceStruct *
  chartInstance, const mxArray *c8_st);
static void finalize_c8_testing_Control(SFc8_testing_ControlInstanceStruct
  *chartInstance);
static void sf_c8_testing_Control(SFc8_testing_ControlInstanceStruct
  *chartInstance);
static void c8_chartstep_c8_testing_Control(SFc8_testing_ControlInstanceStruct
  *chartInstance);
static void initSimStructsc8_testing_Control(SFc8_testing_ControlInstanceStruct *
  chartInstance);
static void init_script_number_translation(uint32_T c8_machineNumber, uint32_T
  c8_chartNumber);
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData);
static real_T c8_emlrt_marshallIn(SFc8_testing_ControlInstanceStruct
  *chartInstance, const mxArray *c8_dc2, const char_T *c8_identifier);
static real_T c8_b_emlrt_marshallIn(SFc8_testing_ControlInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static const mxArray *c8_b_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static creal_T c8_c_emlrt_marshallIn(SFc8_testing_ControlInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static const mxArray *c8_c_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static boolean_T c8_d_emlrt_marshallIn(SFc8_testing_ControlInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static void c8_info_helper(c8_ResolvedFunctionInfo c8_info[34]);
static real_T c8_angle(SFc8_testing_ControlInstanceStruct *chartInstance,
  creal_T c8_h);
static real_T c8_wrapTo2Pi(SFc8_testing_ControlInstanceStruct *chartInstance,
  real_T c8_lambda);
static void c8_pol2cart(SFc8_testing_ControlInstanceStruct *chartInstance,
  real_T c8_th, real_T c8_r, real_T *c8_x, real_T *c8_y);
static const mxArray *c8_d_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static int32_T c8_e_emlrt_marshallIn(SFc8_testing_ControlInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static uint8_T c8_f_emlrt_marshallIn(SFc8_testing_ControlInstanceStruct
  *chartInstance, const mxArray *c8_b_is_active_c8_testing_Control, const char_T
  *c8_identifier);
static uint8_T c8_g_emlrt_marshallIn(SFc8_testing_ControlInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void init_dsm_address_info(SFc8_testing_ControlInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c8_is_active_c8_testing_Control = 0U;
}
  ...
  (SFc8_testing_ControlInstanceStruct *chartInstance)
{
  ...
  c8_e_hoistedGlobal = chartInstance->c8_is_active_c8_testing_Control;
  ...
  chartInstance, const mxArray *c8_st)
{
  ...
  *c8_s2 = c8_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c8_u, 3)),
    "s2");
  chartInstance->c8_is_active_c8_testing_Control = c8_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c8_u, 4)),
     "is_active_c8_testing_Control");
  sf_mex_destroy(&c8_u);
  c8_update_debugger_state_c8_testing_Control(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c8_sfEvent = CALL_EVENT;
  c8_chartstep_c8_testing_Control(chartInstance);
  ...
  *chartInstance)
{
  ...
  sf_mex_call_debug("disp", 0U, 1U, 14, c8_c_y);
  ...
  switch ((int32_T)_SFD_INTEGER_CHECK("sext", c8_sext)) {
   ...
   case 3:
    ...
    c8_pol2cart(chartInstance, 4.1887902047863905, c8_Vdc, &c8_h_t1, &c8_h_t2);
    c8_t1 = c8_h_t1;
    c8_t2 = c8_h_t2;
  ...
  _SFD_EML_CALL(0U, chartInstance->c8_sfEvent, 73);
  sf_mex_printf("%s =\\n", "v1");
  c8_b_u = c8_v1;
  c8_d_y = NULL;
  sf_mex_assign(&c8_d_y, sf_mex_create("y", &c8_b_u, 0, 1U, 0U, 0U, 0), FALSE);
  sf_mex_call_debug("disp", 0U, 1U, 14, c8_d_y);
  _SFD_EML_CALL(0U, chartInstance->c8_sfEvent, 74);
  sf_mex_printf("%s =\\n", "v2");
  c8_c_u = c8_v2;
  c8_e_y = NULL;
  sf_mex_assign(&c8_e_y, sf_mex_create("y", &c8_c_u, 0, 1U, 0U, 0U, 0), FALSE);
  sf_mex_call_debug("disp", 0U, 1U, 14, c8_e_y);
  ...
  c8_f_x = c8_e_x;
  c8_h_y = c8_g_y;
  c8_i_y = c8_f_x / c8_h_y;
  c8_num = c8_Vb - c8_i_y;
  sf_mex_printf("%s =\\n", "num");
  c8_d_u = c8_num;
  c8_j_y = NULL;
  sf_mex_assign(&c8_j_y, sf_mex_create("y", &c8_d_u, 0, 0U, 0U, 0U, 0), FALSE);
  sf_mex_call_debug("disp", 0U, 1U, 14, c8_j_y);
  _SFD_EML_CALL(0U, chartInstance->c8_sfEvent, 76);
  c8_b_a = c8_v1.im;
  c8_m_b = c8_v2.re;
  c8_k_y = c8_b_a * c8_m_b;
  c8_c_A = c8_k_y;
  c8_b_B = c8_v1.re;
  c8_g_x = c8_c_A;
  c8_l_y = c8_b_B;
  c8_h_x = c8_g_x;
  c8_m_y = c8_l_y;
  c8_n_y = c8_h_x / c8_m_y;
  c8_den = c8_v2.im - c8_n_y;
  sf_mex_printf("%s =\\n", "den");
  c8_e_u = c8_den;
  c8_o_y = NULL;
  sf_mex_assign(&c8_o_y, sf_mex_create("y", &c8_e_u, 0, 0U, 0U, 0U, 0), FALSE);
  sf_mex_call_debug("disp", 0U, 1U, 14, c8_o_y);
...
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData)
{
  ...
  const mxArray *c8_y = NULL;
  SFc8_testing_ControlInstanceStruct *chartInstance;
  chartInstance = (SFc8_testing_ControlInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c8_testing_Control_get_eml_resolved_functions_info(void)
{
  ...
  creal_T c8_h)
{
  ...
  sf_debug_symbol_scope_add_eml_importable(&c8_p, 3U, c8_sf_marshallOut,
    c8_sf_marshallIn);
  CV_EML_FCN(0, 2);
  _SFD_EML_CALL(0U, chartInstance->c8_sfEvent, 132U);
  c8_y = c8_h.im;
  c8_x = c8_h.re;
  c8_b_y = c8_y;
  c8_b_x = c8_x;
  c8_p = muDoubleScalarAtan2(c8_b_y, c8_b_x);
  _SFD_EML_CALL(0U, chartInstance->c8_sfEvent, -132);
  sf_debug_symbol_scope_pop();
  return c8_p;
}
  ...
  real_T c8_lambda)
{
  ...
  sf_debug_symbol_switch(3U, 4U);
  _SFD_EML_CALL(0U, chartInstance->c8_sfEvent, 116);
  ...
  *c8_identifier)
{
  ...
  c8_y = c8_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c8_b_is_active_c8_testing_Control), &c8_thisId);
  sf_mex_destroy(&c8_b_is_active_c8_testing_Control);
  return c8_y;
}
...
/* SFunction Glue Code */
void sf_c8_testing_Control_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c8_testing_Control_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c8_testing_Control(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[9],T\"dc1\",},{M[1],M[10],T\"dc2\",},{M[1],M[5],T\"s1\",},{M[1],M[7],T\"s2\",},{M[8],M[0],T\"is_active_c8_testing_Control\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c8_testing_Control_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc8_testing_ControlInstanceStruct *chartInstance;
    chartInstance = (SFc8_testing_ControlInstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (_testing_ControlMachineNumber_,
           8,
           1,
           1,
           7,
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_testing_ControlMachineNumber_,
            chartInstance->chartNumber);
          sf_debug_set_chart_disable_implicit_casting
            (_testing_ControlMachineNumber_,chartInstance->chartNumber,1);
          sf_debug_set_chart_event_thresholds(_testing_ControlMachineNumber_,
            chartInstance->chartNumber,
            0,
            0,
            0);
      ...
      sf_debug_reset_current_state_configuration(_testing_ControlMachineNumber_,
        chartInstance->chartNumber,chartInstance->instanceNumber);
    }
  }
}
...
static void sf_opaque_initialize_c8_testing_Control(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc8_testing_ControlInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c8_testing_Control((SFc8_testing_ControlInstanceStruct*)
    chartInstanceVar);
  initialize_c8_testing_Control((SFc8_testing_ControlInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c8_testing_Control(void *chartInstanceVar)
{
  enable_c8_testing_Control((SFc8_testing_ControlInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c8_testing_Control(void *chartInstanceVar)
{
  disable_c8_testing_Control((SFc8_testing_ControlInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c8_testing_Control(void *chartInstanceVar)
{
  sf_c8_testing_Control((SFc8_testing_ControlInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c8_testing_Control(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c8_testing_Control
    ((SFc8_testing_ControlInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c8_testing_Control();/* state var info */
...
extern void sf_internal_set_sim_state_c8_testing_Control(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c8_testing_Control((SFc8_testing_ControlInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c8_testing_Control(SimStruct* S)
{
  return sf_internal_get_sim_state_c8_testing_Control(S);
}

static void sf_opaque_set_sim_state_c8_testing_Control(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c8_testing_Control(S, st);
}

static void sf_opaque_terminate_c8_testing_Control(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc8_testing_ControlInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c8_testing_Control((SFc8_testing_ControlInstanceStruct*)
      chartInstanceVar);
    free((void *)chartInstanceVar);
    ssSetUserData(S,NULL);
  }

  unload_testing_Control_optimization_info();
}

static void sf_opaque_init_subchart_simstructs(void *chartInstanceVar)
{
  initSimStructsc8_testing_Control((SFc8_testing_ControlInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_testing_Control(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c8_testing_Control(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c8_testing_Control(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c8_testing_Control(SimStruct *S)
{
  SFc8_testing_ControlInstanceStruct *chartInstance;
  chartInstance = (SFc8_testing_ControlInstanceStruct *)malloc(sizeof
    (SFc8_testing_ControlInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc8_testing_ControlInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c8_testing_Control;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c8_testing_Control;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c8_testing_Control;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c8_testing_Control;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c8_testing_Control;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c8_testing_Control;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c8_testing_Control;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c8_testing_Control;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c8_testing_Control;
  chartInstance->chartInfo.mdlStart = mdlStart_c8_testing_Control;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c8_testing_Control;
...
void c8_testing_Control_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_testing_Control(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_testing_Control(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_testing_Control(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c8_testing_Control_method_dispatcher.\n"
