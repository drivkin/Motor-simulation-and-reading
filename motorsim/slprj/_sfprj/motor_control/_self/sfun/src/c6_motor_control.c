...
static void initialize_c6_motor_control(SFc6_motor_controlInstanceStruct
  *chartInstance);
static void initialize_params_c6_motor_control(SFc6_motor_controlInstanceStruct *
  chartInstance);
static void enable_c6_motor_control(SFc6_motor_controlInstanceStruct
  *chartInstance);
static void disable_c6_motor_control(SFc6_motor_controlInstanceStruct
  *chartInstance);
static void c6_update_debugger_state_c6_motor_control
  (SFc6_motor_controlInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c6_motor_control
  (SFc6_motor_controlInstanceStruct *chartInstance);
static void set_sim_state_c6_motor_control(SFc6_motor_controlInstanceStruct
  *chartInstance, const mxArray *c6_st);
static void finalize_c6_motor_control(SFc6_motor_controlInstanceStruct
  *chartInstance);
...
static void c6_chartstep_c6_motor_control(SFc6_motor_controlInstanceStruct
  *chartInstance);
static void initSimStructsc6_motor_control(SFc6_motor_controlInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c6_machineNumber, uint32_T
  c6_chartNumber);
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData);
static real_T c6_emlrt_marshallIn(SFc6_motor_controlInstanceStruct
  *chartInstance, const mxArray *c6_Xbeta, const char_T *c6_identifier);
static real_T c6_b_emlrt_marshallIn(SFc6_motor_controlInstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static const mxArray *c6_b_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static void c6_c_emlrt_marshallIn(SFc6_motor_controlInstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId,
  real_T c6_y[2]);
...
static void c6_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static void c6_eml_scalar_eg(SFc6_motor_controlInstanceStruct *chartInstance);
static const mxArray *c6_d_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static int32_T c6_e_emlrt_marshallIn(SFc6_motor_controlInstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static uint8_T c6_f_emlrt_marshallIn(SFc6_motor_controlInstanceStruct
  *chartInstance, const mxArray *c6_b_is_active_c6_motor_control, const char_T
  *c6_identifier);
static uint8_T c6_g_emlrt_marshallIn(SFc6_motor_controlInstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void init_dsm_address_info(SFc6_motor_controlInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c6_is_active_c6_motor_control = 0U;
}
  ...
  (SFc6_motor_controlInstanceStruct *chartInstance)
{
  ...
  c6_c_hoistedGlobal = chartInstance->c6_is_active_c6_motor_control;
...
const mxArray *sf_c6_motor_control_get_eml_resolved_functions_info(void)
{
  ...
  *c6_identifier)
{
  ...
  c6_y = c6_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c6_b_is_active_c6_motor_control), &c6_thisId);
  sf_mex_destroy(&c6_b_is_active_c6_motor_control);
  return c6_y;
}
...
/* SFunction Glue Code */
void sf_c6_motor_control_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c6_motor_control_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c6_motor_control(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"Xalpha\",},{M[1],M[8],T\"Xbeta\",},{M[8],M[0],T\"is_active_c6_motor_control\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c6_motor_control_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc6_motor_controlInstanceStruct *chartInstance;
    chartInstance = (SFc6_motor_controlInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c6_motor_control(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc6_motor_controlInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c6_motor_control((SFc6_motor_controlInstanceStruct*)
    chartInstanceVar);
  initialize_c6_motor_control((SFc6_motor_controlInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c6_motor_control(void *chartInstanceVar)
{
  enable_c6_motor_control((SFc6_motor_controlInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c6_motor_control(void *chartInstanceVar)
{
  disable_c6_motor_control((SFc6_motor_controlInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c6_motor_control(void *chartInstanceVar)
{
  sf_c6_motor_control((SFc6_motor_controlInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c6_motor_control(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c6_motor_control
    ((SFc6_motor_controlInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c6_motor_control();/* state var info */
...
extern void sf_internal_set_sim_state_c6_motor_control(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c6_motor_control((SFc6_motor_controlInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c6_motor_control(SimStruct* S)
{
  return sf_internal_get_sim_state_c6_motor_control(S);
}

static void sf_opaque_set_sim_state_c6_motor_control(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c6_motor_control(S, st);
}

static void sf_opaque_terminate_c6_motor_control(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc6_motor_controlInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c6_motor_control((SFc6_motor_controlInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc6_motor_control((SFc6_motor_controlInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c6_motor_control(SimStruct *S)
{
  int i;
...
static void mdlRTW_c6_motor_control(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c6_motor_control(SimStruct *S)
{
  SFc6_motor_controlInstanceStruct *chartInstance;
  chartInstance = (SFc6_motor_controlInstanceStruct *)malloc(sizeof
    (SFc6_motor_controlInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc6_motor_controlInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c6_motor_control;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c6_motor_control;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c6_motor_control;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c6_motor_control;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c6_motor_control;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c6_motor_control;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c6_motor_control;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c6_motor_control;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c6_motor_control;
  chartInstance->chartInfo.mdlStart = mdlStart_c6_motor_control;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c6_motor_control;
...
void c6_motor_control_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c6_motor_control(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c6_motor_control(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c6_motor_control(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c6_motor_control_method_dispatcher.\n"
