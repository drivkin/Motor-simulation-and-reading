...
static const char * c4_debug_family_names[17] = { "ang", "sext", "v1", "v2",
...
static void initialize_c4_testing_SVM(SFc4_testing_SVMInstanceStruct
  *chartInstance);
static void initialize_params_c4_testing_SVM(SFc4_testing_SVMInstanceStruct
  *chartInstance);
static void enable_c4_testing_SVM(SFc4_testing_SVMInstanceStruct *chartInstance);
static void disable_c4_testing_SVM(SFc4_testing_SVMInstanceStruct *chartInstance);
static void c4_update_debugger_state_c4_testing_SVM
  (SFc4_testing_SVMInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c4_testing_SVM
  (SFc4_testing_SVMInstanceStruct *chartInstance);
static void set_sim_state_c4_testing_SVM(SFc4_testing_SVMInstanceStruct
  *chartInstance, const mxArray *c4_st);
static void finalize_c4_testing_SVM(SFc4_testing_SVMInstanceStruct
  *chartInstance);
static void sf_c4_testing_SVM(SFc4_testing_SVMInstanceStruct *chartInstance);
static void c4_chartstep_c4_testing_SVM(SFc4_testing_SVMInstanceStruct
  *chartInstance);
static void initSimStructsc4_testing_SVM(SFc4_testing_SVMInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c4_machineNumber, uint32_T
  c4_chartNumber);
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData);
static real_T c4_emlrt_marshallIn(SFc4_testing_SVMInstanceStruct *chartInstance,
  const mxArray *c4_dc2, const char_T *c4_identifier);
static real_T c4_b_emlrt_marshallIn(SFc4_testing_SVMInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_b_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static creal_T c4_c_emlrt_marshallIn(SFc4_testing_SVMInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_c_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static boolean_T c4_d_emlrt_marshallIn(SFc4_testing_SVMInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static void c4_info_helper(c4_ResolvedFunctionInfo c4_info[34]);
static real_T c4_angle(SFc4_testing_SVMInstanceStruct *chartInstance, creal_T
  c4_h);
static real_T c4_wrapTo2Pi(SFc4_testing_SVMInstanceStruct *chartInstance, real_T
  c4_lambda);
static void c4_pol2cart(SFc4_testing_SVMInstanceStruct *chartInstance, real_T
  c4_th, real_T c4_r, real_T *c4_x, real_T *c4_y);
static const mxArray *c4_d_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int32_T c4_e_emlrt_marshallIn(SFc4_testing_SVMInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static uint8_T c4_f_emlrt_marshallIn(SFc4_testing_SVMInstanceStruct
  *chartInstance, const mxArray *c4_b_is_active_c4_testing_SVM, const char_T
  *c4_identifier);
static uint8_T c4_g_emlrt_marshallIn(SFc4_testing_SVMInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void init_dsm_address_info(SFc4_testing_SVMInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_testing_SVM = 0U;
}
  ...
  (SFc4_testing_SVMInstanceStruct *chartInstance)
{
  ...
  c4_e_hoistedGlobal = chartInstance->c4_is_active_c4_testing_SVM;
  ...
  *chartInstance, const mxArray *c4_st)
{
  ...
  *c4_s2 = c4_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 3)),
    "s2");
  chartInstance->c4_is_active_c4_testing_SVM = c4_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 4)),
     "is_active_c4_testing_SVM");
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_testing_SVM(chartInstance);
...
static void sf_c4_testing_SVM(SFc4_testing_SVMInstanceStruct *chartInstance)
{
  ...
  chartInstance->c4_sfEvent = CALL_EVENT;
  c4_chartstep_c4_testing_SVM(chartInstance);
  ...
  *chartInstance)
{
  ...
  sf_debug_symbol_scope_add_eml_importable(&c4_nargout, 9U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(&c4_Va, 10U, c4_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c4_Vb, 11U, c4_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c4_Vdc, 12U, c4_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(&c4_s1, 13U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c4_dc1, 14U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c4_s2, 15U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c4_dc2, 16U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  sf_mex_call_debug("disp", 0U, 1U, 14, c4_c_y);
  ...
  switch ((int32_T)_SFD_INTEGER_CHECK("sext", c4_sext)) {
   case 0:
    ...
    c4_r = c4_Vdc;
    c4_b_t1 = c4_r * 0.50000000000000011;
    c4_b_t2 = c4_r * 0.8660254037844386;
    c4_t1 = c4_b_t1;
    c4_t2 = c4_b_t2;
   ...
   case 1:
    ...
    c4_b_r = c4_Vdc;
    c4_c_t1 = c4_b_r * 0.50000000000000011;
    c4_c_t2 = c4_b_r * 0.8660254037844386;
    c4_t1 = c4_c_t1;
    c4_t2 = c4_c_t2;
    ...
    c4_c_r = c4_Vdc;
    c4_d_t1 = c4_c_r * -0.49999999999999978;
    c4_d_t2 = c4_c_r * 0.86602540378443871;
    c4_t1 = c4_d_t1;
    c4_t2 = c4_d_t2;
   ...
   case 2:
    ...
    c4_d_r = c4_Vdc;
    c4_e_t1 = c4_d_r * -0.49999999999999978;
    c4_e_t2 = c4_d_r * 0.86602540378443871;
    c4_t1 = c4_e_t1;
    c4_t2 = c4_e_t2;
    ...
    c4_e_r = c4_Vdc;
    c4_f_t1 = -c4_e_r;
    c4_f_t2 = c4_e_r * 1.2246467991473532E-16;
    c4_t1 = c4_f_t1;
    c4_t2 = c4_f_t2;
   ...
   case 3:
    ...
    c4_pol2cart(chartInstance, 3.1415926535897931, c4_Vdc, &c4_g_t1, &c4_g_t2);
    c4_t1 = c4_g_t1;
    c4_t2 = c4_g_t2;
    ...
    c4_pol2cart(chartInstance, 4.1887902047863905, c4_Vdc, &c4_h_t1, &c4_h_t2);
    c4_t1 = c4_h_t1;
    c4_t2 = c4_h_t2;
   ...
   case 4:
    ...
    c4_pol2cart(chartInstance, 4.1887902047863905, c4_Vdc, &c4_i_t1, &c4_i_t2);
    c4_t1 = c4_i_t1;
    c4_t2 = c4_i_t2;
    ...
    c4_pol2cart(chartInstance, 5.2359877559829888, c4_Vdc, &c4_j_t1, &c4_j_t2);
    c4_t1 = c4_j_t1;
    c4_t2 = c4_j_t2;
   ...
   case 5:
    ...
    c4_pol2cart(chartInstance, 5.2359877559829888, c4_Vdc, &c4_k_t1, &c4_k_t2);
    c4_t1 = c4_k_t1;
    c4_t2 = c4_k_t2;
  ...
  c4_b_u = c4_v1;
  c4_d_y = NULL;
  sf_mex_assign(&c4_d_y, sf_mex_create("y", &c4_b_u, 0, 1U, 0U, 0U, 0), FALSE);
  sf_mex_call_debug("disp", 0U, 1U, 14, c4_d_y);
  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 74);
  sf_mex_printf("%s =\\n", "v2");
  c4_c_u = c4_v2;
  c4_e_y = NULL;
  sf_mex_assign(&c4_e_y, sf_mex_create("y", &c4_c_u, 0, 1U, 0U, 0U, 0), FALSE);
  sf_mex_call_debug("disp", 0U, 1U, 14, c4_e_y);
  ...
  c4_d_u = c4_num;
  c4_j_y = NULL;
  sf_mex_assign(&c4_j_y, sf_mex_create("y", &c4_d_u, 0, 0U, 0U, 0U, 0), FALSE);
  sf_mex_call_debug("disp", 0U, 1U, 14, c4_j_y);
  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 76);
  c4_b_a = c4_v1.im;
  c4_m_b = c4_v2.re;
  c4_k_y = c4_b_a * c4_m_b;
  c4_c_A = c4_k_y;
  c4_b_B = c4_v1.re;
  c4_g_x = c4_c_A;
  c4_l_y = c4_b_B;
  c4_h_x = c4_g_x;
  c4_m_y = c4_l_y;
  c4_n_y = c4_h_x / c4_m_y;
  c4_den = c4_v2.im - c4_n_y;
  sf_mex_printf("%s =\\n", "den");
  c4_e_u = c4_den;
  c4_o_y = NULL;
  sf_mex_assign(&c4_o_y, sf_mex_create("y", &c4_e_u, 0, 0U, 0U, 0U, 0), FALSE);
  sf_mex_call_debug("disp", 0U, 1U, 14, c4_o_y);
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  const mxArray *c4_y = NULL;
  SFc4_testing_SVMInstanceStruct *chartInstance;
  chartInstance = (SFc4_testing_SVMInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c4_testing_SVM_get_eml_resolved_functions_info(void)
{
  const mxArray *c4_nameCaptureInfo;
  c4_ResolvedFunctionInfo c4_info[34];
  ...
  sf_mex_assign(&c4_m0, sf_mex_createstruct("nameCaptureInfo", 1, 34), FALSE);
  for (c4_i0 = 0; c4_i0 < 34; c4_i0++) {
    c4_r0 = &c4_info[c4_i0];
  ...
  *c4_identifier)
{
  ...
  c4_y = c4_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_testing_SVM), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_testing_SVM);
  return c4_y;
}
...
/* SFunction Glue Code */
void sf_c4_testing_SVM_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(66097630U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(778239261U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(858067289U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3931171336U);
}

mxArray *sf_c4_testing_SVM_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("EMX3ib0abfHmZP7uaBY1ZH");
...
static const mxArray *sf_get_sim_state_info_c4_testing_SVM(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[9],T\"dc1\",},{M[1],M[10],T\"dc2\",},{M[1],M[5],T\"s1\",},{M[1],M[7],T\"s2\",},{M[8],M[0],T\"is_active_c4_testing_SVM\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_testing_SVM_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc4_testing_SVMInstanceStruct *chartInstance;
    chartInstance = (SFc4_testing_SVMInstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,1,"wrapTo2Pi",2481,-1,3074);
        _SFD_CV_INIT_EML_FCN(0,2,"angle",3076,-1,3432);

        {
          static int caseStart[] = { 1740, 551, 723, 944, 1150, 1356, 1579 };

          static int caseExprEnd[] = { 1749, 557, 729, 950, 1156, 1362, 1585 };

          _SFD_CV_INIT_EML_SWITCH(0,1,0,531,543,1797,7,&(caseStart[0]),
            &(caseExprEnd[0]));
        }
...
{
  return "MTAPRoKfonTv36GK28bHPE";
}

static void sf_opaque_initialize_c4_testing_SVM(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc4_testing_SVMInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c4_testing_SVM((SFc4_testing_SVMInstanceStruct*)
    chartInstanceVar);
  initialize_c4_testing_SVM((SFc4_testing_SVMInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c4_testing_SVM(void *chartInstanceVar)
{
  enable_c4_testing_SVM((SFc4_testing_SVMInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c4_testing_SVM(void *chartInstanceVar)
{
  disable_c4_testing_SVM((SFc4_testing_SVMInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c4_testing_SVM(void *chartInstanceVar)
{
  sf_c4_testing_SVM((SFc4_testing_SVMInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c4_testing_SVM(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c4_testing_SVM
    ((SFc4_testing_SVMInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c4_testing_SVM();/* state var info */
...
extern void sf_internal_set_sim_state_c4_testing_SVM(SimStruct* S, const mxArray
  *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c4_testing_SVM((SFc4_testing_SVMInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c4_testing_SVM(SimStruct* S)
{
  return sf_internal_get_sim_state_c4_testing_SVM(S);
}

static void sf_opaque_set_sim_state_c4_testing_SVM(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c4_testing_SVM(S, st);
}

static void sf_opaque_terminate_c4_testing_SVM(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_testing_SVMInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c4_testing_SVM((SFc4_testing_SVMInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc4_testing_SVM((SFc4_testing_SVMInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_testing_SVM(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c4_testing_SVM(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(2955980684U));
  ssSetChecksum1(S,(566964344U));
  ssSetChecksum2(S,(80040602U));
  ssSetChecksum3(S,(2371324071U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c4_testing_SVM(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_testing_SVM(SimStruct *S)
{
  SFc4_testing_SVMInstanceStruct *chartInstance;
  chartInstance = (SFc4_testing_SVMInstanceStruct *)malloc(sizeof
    (SFc4_testing_SVMInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc4_testing_SVMInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c4_testing_SVM;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c4_testing_SVM;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c4_testing_SVM;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c4_testing_SVM;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c4_testing_SVM;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c4_testing_SVM;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c4_testing_SVM;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c4_testing_SVM;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_testing_SVM;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_testing_SVM;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c4_testing_SVM;
...
void c4_testing_SVM_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_testing_SVM(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_testing_SVM(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_testing_SVM(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_testing_SVM_method_dispatcher.\n"
