...
static void initialize_c3_testing_SVM(SFc3_testing_SVMInstanceStruct
  *chartInstance);
static void initialize_params_c3_testing_SVM(SFc3_testing_SVMInstanceStruct
  *chartInstance);
static void enable_c3_testing_SVM(SFc3_testing_SVMInstanceStruct *chartInstance);
static void disable_c3_testing_SVM(SFc3_testing_SVMInstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_testing_SVM
  (SFc3_testing_SVMInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_testing_SVM
  (SFc3_testing_SVMInstanceStruct *chartInstance);
static void set_sim_state_c3_testing_SVM(SFc3_testing_SVMInstanceStruct
  *chartInstance, const mxArray *c3_st);
static void finalize_c3_testing_SVM(SFc3_testing_SVMInstanceStruct
  *chartInstance);
static void sf_c3_testing_SVM(SFc3_testing_SVMInstanceStruct *chartInstance);
static void initSimStructsc3_testing_SVM(SFc3_testing_SVMInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static real_T c3_emlrt_marshallIn(SFc3_testing_SVMInstanceStruct *chartInstance,
  const mxArray *c3_pwmc, const char_T *c3_identifier);
static real_T c3_b_emlrt_marshallIn(SFc3_testing_SVMInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_b_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_c_emlrt_marshallIn(SFc3_testing_SVMInstanceStruct *chartInstance,
...
static real_T c3_mpower(SFc3_testing_SVMInstanceStruct *chartInstance, real_T
  c3_a);
static void c3_eml_error(SFc3_testing_SVMInstanceStruct *chartInstance);
static const mxArray *c3_c_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_d_emlrt_marshallIn(SFc3_testing_SVMInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_e_emlrt_marshallIn(SFc3_testing_SVMInstanceStruct
  *chartInstance, const mxArray *c3_b_is_active_c3_testing_SVM, const char_T
  *c3_identifier);
static uint8_T c3_f_emlrt_marshallIn(SFc3_testing_SVMInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void init_dsm_address_info(SFc3_testing_SVMInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_testing_SVM = 0U;
}
  ...
  (SFc3_testing_SVMInstanceStruct *chartInstance)
{
  ...
  c3_d_hoistedGlobal = chartInstance->c3_is_active_c3_testing_SVM;
  ...
  *chartInstance, const mxArray *c3_st)
{
  ...
  *c3_pwmc = c3_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u,
    2)), "pwmc");
  chartInstance->c3_is_active_c3_testing_SVM = c3_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 3)),
     "is_active_c3_testing_SVM");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_testing_SVM(chartInstance);
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_testing_SVMInstanceStruct *chartInstance;
  chartInstance = (SFc3_testing_SVMInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c3_testing_SVM_get_eml_resolved_functions_info(void)
{
  ...
  *c3_identifier)
{
  ...
  c3_y = c3_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_testing_SVM), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_testing_SVM);
  return c3_y;
}
...
/* SFunction Glue Code */
void sf_c3_testing_SVM_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c3_testing_SVM_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c3_testing_SVM(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[5],T\"pwma\",},{M[1],M[12],T\"pwmb\",},{M[1],M[13],T\"pwmc\",},{M[8],M[0],T\"is_active_c3_testing_SVM\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_testing_SVM_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc3_testing_SVMInstanceStruct *chartInstance;
    chartInstance = (SFc3_testing_SVMInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c3_testing_SVM(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_testing_SVMInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c3_testing_SVM((SFc3_testing_SVMInstanceStruct*)
    chartInstanceVar);
  initialize_c3_testing_SVM((SFc3_testing_SVMInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c3_testing_SVM(void *chartInstanceVar)
{
  enable_c3_testing_SVM((SFc3_testing_SVMInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c3_testing_SVM(void *chartInstanceVar)
{
  disable_c3_testing_SVM((SFc3_testing_SVMInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c3_testing_SVM(void *chartInstanceVar)
{
  sf_c3_testing_SVM((SFc3_testing_SVMInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_testing_SVM(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_testing_SVM
    ((SFc3_testing_SVMInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_testing_SVM();/* state var info */
...
extern void sf_internal_set_sim_state_c3_testing_SVM(SimStruct* S, const mxArray
  *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c3_testing_SVM((SFc3_testing_SVMInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_testing_SVM(SimStruct* S)
{
  return sf_internal_get_sim_state_c3_testing_SVM(S);
}

static void sf_opaque_set_sim_state_c3_testing_SVM(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c3_testing_SVM(S, st);
}

static void sf_opaque_terminate_c3_testing_SVM(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_testing_SVMInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c3_testing_SVM((SFc3_testing_SVMInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc3_testing_SVM((SFc3_testing_SVMInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_testing_SVM(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_testing_SVM(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c3_testing_SVM(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_testing_SVM(SimStruct *S)
{
  SFc3_testing_SVMInstanceStruct *chartInstance;
  chartInstance = (SFc3_testing_SVMInstanceStruct *)malloc(sizeof
    (SFc3_testing_SVMInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_testing_SVMInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c3_testing_SVM;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c3_testing_SVM;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c3_testing_SVM;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_testing_SVM;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c3_testing_SVM;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c3_testing_SVM;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c3_testing_SVM;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_testing_SVM;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_testing_SVM;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_testing_SVM;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c3_testing_SVM;
...
void c3_testing_SVM_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_testing_SVM(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_testing_SVM(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_testing_SVM(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_testing_SVM_method_dispatcher.\n"
