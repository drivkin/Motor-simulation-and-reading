...
#include "c1_motor_control_with_off_the_shelf_SVPWM.h"
...
static void initialize_c1_motor_control_with_off_the_shelf_SVPWM
  (SFc1_motor_control_with_off_the_shelf_SVPWMInstanceStruct *chartInstance);
static void initialize_params_c1_motor_control_with_off_the_shelf_SVPWM
  (SFc1_motor_control_with_off_the_shelf_SVPWMInstanceStruct *chartInstance);
static void enable_c1_motor_control_with_off_the_shelf_SVPWM
  (SFc1_motor_control_with_off_the_shelf_SVPWMInstanceStruct *chartInstance);
static void disable_c1_motor_control_with_off_the_shelf_SVPWM
  (SFc1_motor_control_with_off_the_shelf_SVPWMInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_motor_control_with_off_the_shelf_SVP
  (SFc1_motor_control_with_off_the_shelf_SVPWMInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_motor_control_with_off_the_shelf_SVPWM
  (SFc1_motor_control_with_off_the_shelf_SVPWMInstanceStruct *chartInstance);
static void set_sim_state_c1_motor_control_with_off_the_shelf_SVPWM
  (SFc1_motor_control_with_off_the_shelf_SVPWMInstanceStruct *chartInstance,
   const mxArray *c1_st);
static void finalize_c1_motor_control_with_off_the_shelf_SVPWM
  (SFc1_motor_control_with_off_the_shelf_SVPWMInstanceStruct *chartInstance);
static void sf_c1_motor_control_with_off_the_shelf_SVPWM
  (SFc1_motor_control_with_off_the_shelf_SVPWMInstanceStruct *chartInstance);
static void initSimStructsc1_motor_control_with_off_the_shelf_SVPWM
  (SFc1_motor_control_with_off_the_shelf_SVPWMInstanceStruct *chartInstance);
  ...
  (SFc1_motor_control_with_off_the_shelf_SVPWMInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_motor_control_with_off_the_shelf_SVPWM = 0U;
}
...
/* SFunction Glue Code */
void sf_c1_motor_control_with_off_the_shelf_SVPWM_get_check_sum(mxArray *plhs[])
{
...
static void sf_opaque_initialize_c1_motor_control_with_off_the_shelf_SVPWM(void *
  chartInstanceVar)
{
  chart_debug_initialization
    (((SFc1_motor_control_with_off_the_shelf_SVPWMInstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c1_motor_control_with_off_the_shelf_SVPWM
    ((SFc1_motor_control_with_off_the_shelf_SVPWMInstanceStruct*)
     chartInstanceVar);
  initialize_c1_motor_control_with_off_the_shelf_SVPWM
    ((SFc1_motor_control_with_off_the_shelf_SVPWMInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c1_motor_control_with_off_the_shelf_SVPWM(void
  *chartInstanceVar)
{
  enable_c1_motor_control_with_off_the_shelf_SVPWM
    ((SFc1_motor_control_with_off_the_shelf_SVPWMInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c1_motor_control_with_off_the_shelf_SVPWM(void
  *chartInstanceVar)
{
  disable_c1_motor_control_with_off_the_shelf_SVPWM
    ((SFc1_motor_control_with_off_the_shelf_SVPWMInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c1_motor_control_with_off_the_shelf_SVPWM(void
  *chartInstanceVar)
{
  sf_c1_motor_control_with_off_the_shelf_SVPWM
    ((SFc1_motor_control_with_off_the_shelf_SVPWMInstanceStruct*)
     chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c1_motor_control_with_off_the_shelf_SVPWM(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_motor_control_with_off_the_shelf_SVPWM
    ((SFc1_motor_control_with_off_the_shelf_SVPWMInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c1_motor_control_with_off_the_shelf_SVPWM();/* state var info */
...
extern void sf_internal_set_sim_state_c1_motor_control_with_off_the_shelf_SVPWM
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c1_motor_control_with_off_the_shelf_SVPWM
    ((SFc1_motor_control_with_off_the_shelf_SVPWMInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c1_motor_control_with_off_the_shelf_SVPWM(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_motor_control_with_off_the_shelf_SVPWM(S);
}

static void sf_opaque_set_sim_state_c1_motor_control_with_off_the_shelf_SVPWM
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c1_motor_control_with_off_the_shelf_SVPWM(S, st);
}

static void sf_opaque_terminate_c1_motor_control_with_off_the_shelf_SVPWM(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_motor_control_with_off_the_shelf_SVPWMInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c1_motor_control_with_off_the_shelf_SVPWM
      ((SFc1_motor_control_with_off_the_shelf_SVPWMInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc1_motor_control_with_off_the_shelf_SVPWM
    ((SFc1_motor_control_with_off_the_shelf_SVPWMInstanceStruct*)
     chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_motor_control_with_off_the_shelf_SVPWM
  (SimStruct *S)
{
  int i;
...
static void mdlRTW_c1_motor_control_with_off_the_shelf_SVPWM(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
void c1_motor_control_with_off_the_shelf_SVPWM_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_motor_control_with_off_the_shelf_SVPWM(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_motor_control_with_off_the_shelf_SVPWM(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_motor_control_with_off_the_shelf_SVPWM(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_motor_control_with_off_the_shelf_SVPWM_method_dispatcher.\n"
