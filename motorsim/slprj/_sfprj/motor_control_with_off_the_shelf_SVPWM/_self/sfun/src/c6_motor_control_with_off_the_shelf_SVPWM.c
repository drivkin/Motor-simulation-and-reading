...
#include "c6_motor_control_with_off_the_shelf_SVPWM.h"
...
static void initialize_c6_motor_control_with_off_the_shelf_SVPWM
  (SFc6_motor_control_with_off_the_shelf_SVPWMInstanceStruct *chartInstance);
static void initialize_params_c6_motor_control_with_off_the_shelf_SVPWM
  (SFc6_motor_control_with_off_the_shelf_SVPWMInstanceStruct *chartInstance);
static void enable_c6_motor_control_with_off_the_shelf_SVPWM
  (SFc6_motor_control_with_off_the_shelf_SVPWMInstanceStruct *chartInstance);
static void disable_c6_motor_control_with_off_the_shelf_SVPWM
  (SFc6_motor_control_with_off_the_shelf_SVPWMInstanceStruct *chartInstance);
static void c6_update_debugger_state_c6_motor_control_with_off_the_shelf_SVP
  (SFc6_motor_control_with_off_the_shelf_SVPWMInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c6_motor_control_with_off_the_shelf_SVPWM
  (SFc6_motor_control_with_off_the_shelf_SVPWMInstanceStruct *chartInstance);
static void set_sim_state_c6_motor_control_with_off_the_shelf_SVPWM
  (SFc6_motor_control_with_off_the_shelf_SVPWMInstanceStruct *chartInstance,
   const mxArray *c6_st);
static void finalize_c6_motor_control_with_off_the_shelf_SVPWM
  (SFc6_motor_control_with_off_the_shelf_SVPWMInstanceStruct *chartInstance);
static void sf_c6_motor_control_with_off_the_shelf_SVPWM
  (SFc6_motor_control_with_off_the_shelf_SVPWMInstanceStruct *chartInstance);
static void c6_chartstep_c6_motor_control_with_off_the_shelf_SVPWM
  (SFc6_motor_control_with_off_the_shelf_SVPWMInstanceStruct *chartInstance);
static void initSimStructsc6_motor_control_with_off_the_shelf_SVPWM
  (SFc6_motor_control_with_off_the_shelf_SVPWMInstanceStruct *chartInstance);
...
static real_T c6_emlrt_marshallIn
  (SFc6_motor_control_with_off_the_shelf_SVPWMInstanceStruct *chartInstance,
   const mxArray *c6_Xbeta, const char_T *c6_identifier);
...
static uint8_T c6_f_emlrt_marshallIn
  (SFc6_motor_control_with_off_the_shelf_SVPWMInstanceStruct *chartInstance,
   const mxArray *c6_b_is_active_c6_motor_control_with_off_the_shelf_SVPWM,
  ...
  (SFc6_motor_control_with_off_the_shelf_SVPWMInstanceStruct *chartInstance)
{
  ...
  chartInstance->c6_is_active_c6_motor_control_with_off_the_shelf_SVPWM = 0U;
}
  ...
  (SFc6_motor_control_with_off_the_shelf_SVPWMInstanceStruct *chartInstance)
{
  ...
  c6_c_hoistedGlobal =
    chartInstance->c6_is_active_c6_motor_control_with_off_the_shelf_SVPWM;
   ...
   const mxArray *c6_st)
{
  ...
  *c6_Xbeta = c6_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c6_u,
  ...
  chartInstance->c6_is_active_c6_motor_control_with_off_the_shelf_SVPWM =
    ...
    "is_active_c6_motor_control_with_off_the_shelf_SVPWM");
  sf_mex_destroy(&c6_u);
  c6_update_debugger_state_c6_motor_control_with_off_the_shelf_SVP(chartInstance);
  ...
  (SFc6_motor_control_with_off_the_shelf_SVPWMInstanceStruct *chartInstance)
{
  ...
  chartInstance->c6_sfEvent = CALL_EVENT;
  c6_chartstep_c6_motor_control_with_off_the_shelf_SVPWM(chartInstance);
...
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData)
{
  ...
  const mxArray *c6_y = NULL;
  SFc6_motor_control_with_off_the_shelf_SVPWMInstanceStruct *chartInstance;
  chartInstance = (SFc6_motor_control_with_off_the_shelf_SVPWMInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c6_motor_control_with_off_the_shelf_SVPWM_get_eml_resolved_functions_info
  (void)
{
   ...
   const char_T *c6_identifier)
{
  ...
  c6_y = c6_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c6_b_is_active_c6_motor_control_with_off_the_shelf_SVPWM), &c6_thisId);
  sf_mex_destroy(&c6_b_is_active_c6_motor_control_with_off_the_shelf_SVPWM);
  return c6_y;
}
...
/* SFunction Glue Code */
void sf_c6_motor_control_with_off_the_shelf_SVPWM_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c6_motor_control_with_off_the_shelf_SVPWM_get_autoinheritance_info
  (void)
{
...
static const mxArray
  *sf_get_sim_state_info_c6_motor_control_with_off_the_shelf_SVPWM(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"Xalpha\",},{M[1],M[8],T\"Xbeta\",},{M[8],M[0],T\"is_active_c6_motor_control_with_off_the_shelf_SVPWM\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c6_motor_control_with_off_the_shelf_SVPWM_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c6_motor_control_with_off_the_shelf_SVPWM(void *
  chartInstanceVar)
{
  chart_debug_initialization
    (((SFc6_motor_control_with_off_the_shelf_SVPWMInstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c6_motor_control_with_off_the_shelf_SVPWM
    ((SFc6_motor_control_with_off_the_shelf_SVPWMInstanceStruct*)
     chartInstanceVar);
  initialize_c6_motor_control_with_off_the_shelf_SVPWM
    ((SFc6_motor_control_with_off_the_shelf_SVPWMInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c6_motor_control_with_off_the_shelf_SVPWM(void
  *chartInstanceVar)
{
  enable_c6_motor_control_with_off_the_shelf_SVPWM
    ((SFc6_motor_control_with_off_the_shelf_SVPWMInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c6_motor_control_with_off_the_shelf_SVPWM(void
  *chartInstanceVar)
{
  disable_c6_motor_control_with_off_the_shelf_SVPWM
    ((SFc6_motor_control_with_off_the_shelf_SVPWMInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c6_motor_control_with_off_the_shelf_SVPWM(void
  *chartInstanceVar)
{
  sf_c6_motor_control_with_off_the_shelf_SVPWM
    ((SFc6_motor_control_with_off_the_shelf_SVPWMInstanceStruct*)
     chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c6_motor_control_with_off_the_shelf_SVPWM(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c6_motor_control_with_off_the_shelf_SVPWM
    ((SFc6_motor_control_with_off_the_shelf_SVPWMInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c6_motor_control_with_off_the_shelf_SVPWM();/* state var info */
...
extern void sf_internal_set_sim_state_c6_motor_control_with_off_the_shelf_SVPWM
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c6_motor_control_with_off_the_shelf_SVPWM
    ((SFc6_motor_control_with_off_the_shelf_SVPWMInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c6_motor_control_with_off_the_shelf_SVPWM(SimStruct* S)
{
  return sf_internal_get_sim_state_c6_motor_control_with_off_the_shelf_SVPWM(S);
}

static void sf_opaque_set_sim_state_c6_motor_control_with_off_the_shelf_SVPWM
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c6_motor_control_with_off_the_shelf_SVPWM(S, st);
}

static void sf_opaque_terminate_c6_motor_control_with_off_the_shelf_SVPWM(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc6_motor_control_with_off_the_shelf_SVPWMInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c6_motor_control_with_off_the_shelf_SVPWM
      ((SFc6_motor_control_with_off_the_shelf_SVPWMInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc6_motor_control_with_off_the_shelf_SVPWM
    ((SFc6_motor_control_with_off_the_shelf_SVPWMInstanceStruct*)
     chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c6_motor_control_with_off_the_shelf_SVPWM
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c6_motor_control_with_off_the_shelf_SVPWM(SimStruct
  *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c6_motor_control_with_off_the_shelf_SVPWM(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c6_motor_control_with_off_the_shelf_SVPWM(SimStruct *S)
{
  SFc6_motor_control_with_off_the_shelf_SVPWMInstanceStruct *chartInstance;
  chartInstance = (SFc6_motor_control_with_off_the_shelf_SVPWMInstanceStruct *)
    malloc(sizeof(SFc6_motor_control_with_off_the_shelf_SVPWMInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c6_motor_control_with_off_the_shelf_SVPWM;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c6_motor_control_with_off_the_shelf_SVPWM;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c6_motor_control_with_off_the_shelf_SVPWM;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c6_motor_control_with_off_the_shelf_SVPWM;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c6_motor_control_with_off_the_shelf_SVPWM;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c6_motor_control_with_off_the_shelf_SVPWM;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c6_motor_control_with_off_the_shelf_SVPWM;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c6_motor_control_with_off_the_shelf_SVPWM;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c6_motor_control_with_off_the_shelf_SVPWM;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c6_motor_control_with_off_the_shelf_SVPWM;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c6_motor_control_with_off_the_shelf_SVPWM;
...
void c6_motor_control_with_off_the_shelf_SVPWM_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c6_motor_control_with_off_the_shelf_SVPWM(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c6_motor_control_with_off_the_shelf_SVPWM(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c6_motor_control_with_off_the_shelf_SVPWM(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c6_motor_control_with_off_the_shelf_SVPWM_method_dispatcher.\n"
